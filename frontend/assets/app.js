(() => {
  ...
  /* @__PURE__ */ (() => {
    ...
    const start = () => {
      ...
      const cmdInput = $("#cmd");
      const cmdInputDefaultPlaceholder = (cmdInput == null ? void 0 : cmdInput.getAttribute("placeholder")) || "";
      const DISCORD_ALLOWED_PRESENCES = /* @__PURE__ */ new Set(["online", "idle", "dnd", "invisible"]);
      ...
      const logMfa = (message, details = {}) => {
        try {
          const safeDetails = __spreadValues({}, details);
      ...
      logMfa("browser logger ready", {
        page: typeof window !== "undefined" ? (_a = window.location) == null ? void 0 : _a.href : "(no-window)"
      });
      const superuserUi = false;
      const defaultPanel = typeof window !== "undefined" && window.DEFAULT_PANEL ? String(window.DEFAULT_PANEL) : "dashboard";
      const state = {
        API: "",
        TOKEN: localStorage.getItem("token") || "",
        currentUser: null,
        currentServerId: null,
        serverItems: /* @__PURE__ */ new Map(),
      ...
      const rolesSection = (roleManager == null ? void 0 : roleManager.closest(".team-section")) || null;
      ...
      const regionDisplay = typeof Intl !== "undefined" && typeof Intl.DisplayNames === "function" ? new Intl.DisplayNames(["en"], { type: "region" }) : null;
      ...
      const CHAT_REFRESH_INTERVAL_MS = 5e3;
      const KILL_FEED_REFRESH_INTERVAL_MS = 3e4;
      const KILL_FEED_RETENTION_MS = 24 * 60 * 60 * 1e3;
      ...
      const chatState = {
        ...
        lastFetched: /* @__PURE__ */ new Map(),
        loading: false,
        error: null,
        profileCache: /* @__PURE__ */ new Map(),
        profileRequests: /* @__PURE__ */ new Map(),
        teamColors: /* @__PURE__ */ new Map(),
        teamPalettes: /* @__PURE__ */ new Map(),
        playerTeams: /* @__PURE__ */ new Map()
      };
      const killFeedState = {
        cache: /* @__PURE__ */ new Map(),
        lastFetched: /* @__PURE__ */ new Map(),
        renderSignatures: /* @__PURE__ */ new Map(),
        loading: false,
        error: null
      };
      ...
      const f7ProfileCache = /* @__PURE__ */ new Map();
      const f7ProfileRequests = /* @__PURE__ */ new Map();
      const aqState = {
        serverId: null,
        list: [],
        loadingList: false,
      ...
      const moduleSlots = /* @__PURE__ */ new Map();
      document.querySelectorAll("[data-module-card]").forEach((card) => {
        var _a2;
        const id = (_a2 = card == null ? void 0 : card.dataset) == null ? void 0 : _a2.moduleCard;
        if (!id) return;
        ...
        const titleEl = (header == null ? void 0 : header.querySelector("[data-module-title]")) || (header == null ? void 0 : header.querySelector("h3")) || null;
      ...
      function setWorkspaceView(nextView = workspaceViewDefault) {
        ...
        let target = available.has(nextView) ? nextView : ((_a2 = visibleButtons[0]) == null ? void 0 : _a2.dataset.view) || workspaceViewDefault;
        if (!available.has(target)) target = ((_b2 = visibleButtons[0]) == null ? void 0 : _b2.dataset.view) || workspaceViewDefault;
      ...
      if (f7ReportShowAll) {
        f7ReportShowAll.addEventListener("click", () => {
          ...
          const targetSteamId = (_a2 = pickString(detail == null ? void 0 : detail.targetSteamId)) == null ? void 0 : _a2.trim();
          if (!targetSteamId) return;
          const label = pickString(detail == null ? void 0 : detail.targetName) || targetSteamId;
          if (f7State.focusTarget === targetSteamId) {
            clearF7FocusTarget();
          } else {
            focusF7ReportsOnTarget(targetSteamId, label);
          }
          if (f7ReportDetail == null ? void 0 : f7ReportDetail.scrollIntoView) {
            try {
              f7ReportDetail.scrollIntoView({ behavior: "smooth", block: "start" });
            } catch (err) {
            }
          }
        });
      ...
      if (f7ReportOpenProfile) {
        f7ReportOpenProfile.addEventListener("click", () => {
          ...
          if (!(payload == null ? void 0 : payload.steamid)) return;
      ...
      function normalizeChatFilter(value) {
        const text2 = typeof value === "string" ? value.trim().toLowerCase() : "";
        if (text2 === "team") return "team";
        if (text2 === "global") return "global";
        return "all";
      }
      ...
      function normalizeChatColor(value) {
        ...
        const hexMatch = text2.match(/^#?([0-9a-f]{3}|[0-9a-f]{4}|[0-9a-f]{6}|[0-9a-f]{8})$/i);
        if (hexMatch) {
      ...
      function rgbaFromColor(value, alpha = 1) {
        ...
        const a = Math.round(clampAlpha(alpha) * 1e3) / 1e3;
      ...
      function updateServerTeamPalette(serverId, colors) {
        ...
        for (const entry of Array.isArray(colors) ? colors : []) {
          const teamId = normalizeTeamId((_b2 = (_a2 = entry == null ? void 0 : entry.teamId) != null ? _a2 : entry == null ? void 0 : entry.team_id) != null ? _b2 : entry == null ? void 0 : entry.id);
          const color = pickString((_d = (_c = entry == null ? void 0 : entry.color) != null ? _c : entry == null ? void 0 : entry.value) != null ? _d : entry == null ? void 0 : entry.hex);
      ...
      function parseTeamIdFromText(text2) {
      ...
      function resolveTeamIdForEntry(serverId, entry) {
        ...
        if (entrySteamId && Number.isFinite(numericServerId)) {
          ...
          const mapped = teamMap == null ? void 0 : teamMap.get(entrySteamId);
      ...
      function resolveTeamMessageColor(serverId, entry) {
        const numericServerId = Number(serverId);
        const baseColor = getTeamChatColor(numericServerId, entry == null ? void 0 : entry.color);
        ...
        if (teamId != null) {
          ...
          const paletteColor = palette == null ? void 0 : palette.get(teamId);
          const normalized = pickString(paletteColor);
          if (normalized) return normalized;
        }
        const direct = pickString(entry == null ? void 0 : entry.color);
      ...
      function handlePlayersListUpdate(payload = {}) {
        ...
        if (serverId == null && explicitServerId === void 0) {
      ...
      function normalizeChatMessage(payload, fallbackServerId) {
        ...
        const serverId = Number((_b2 = (_a2 = payload == null ? void 0 : payload.serverId) != null ? _a2 : payload == null ? void 0 : payload.server_id) != null ? _b2 : fallbackServerId);
        if (!Number.isFinite(serverId)) return null;
        const messageText = pickString(
          payload == null ? void 0 : payload.message,
          payload == null ? void 0 : payload.Message,
          payload == null ? void 0 : payload.text,
          payload == null ? void 0 : payload.Text,
        ...
        const timestampCandidates = [
          payload == null ? void 0 : payload.createdAt,
          payload == null ? void 0 : payload.created_at,
          payload == null ? void 0 : payload.timestamp,
          payload == null ? void 0 : payload.Timestamp,
          payload == null ? void 0 : payload.Time,
          payload == null ? void 0 : payload.time
        ];
        let createdAt = null;
        ...
        const idValue = (_h = (_g = (_f = (_e = (_d = (_c = payload == null ? void 0 : payload.id) != null ? _c : payload == null ? void 0 : payload.Id) != null ? _d : payload == null ? void 0 : payload.messageId) != null ? _e : payload == null ? void 0 : payload.message_id) != null ? _f : payload == null ? void 0 : payload.MessageId) != null ? _g : payload == null ? void 0 : payload.MessageID) != null ? _h : null;
        let id = null;
        if (idValue != null) {
        ...
        const channel = normalizeChatChannel(pickString(
          payload == null ? void 0 : payload.channel,
          payload == null ? void 0 : payload.Channel,
          payload == null ? void 0 : payload.scope,
          payload == null ? void 0 : payload.Scope,
          payload == null ? void 0 : payload.type,
          payload == null ? void 0 : payload.Type
        ));
        const username = pickString(
          payload == null ? void 0 : payload.username,
          payload == null ? void 0 : payload.Username,
          payload == null ? void 0 : payload.user,
          payload == null ? void 0 : payload.User,
        ...
        const steamId = pickString(
          payload == null ? void 0 : payload.steamId,
          payload == null ? void 0 : payload.SteamId,
          payload == null ? void 0 : payload.steamid,
          payload == null ? void 0 : payload.SteamID,
          ...
          payload == null ? void 0 : payload.UserId,
          payload == null ? void 0 : payload.userid,
          payload == null ? void 0 : payload.playerId,
          payload == null ? void 0 : payload.PlayerId
        );
        const raw = pickString(payload == null ? void 0 : payload.raw, payload == null ? void 0 : payload.Raw);
        const color = normalizeChatColor(pickString(payload == null ? void 0 : payload.color, payload == null ? void 0 : payload.Color));
        return {
          id,
          serverId,
          channel,
          ...
          message: trimmedMessage.length > 4e3 ? trimmedMessage.slice(0, 4e3) : trimmedMessage,
          createdAt,
          raw: raw || null,
          color: color || null
        };
      ...
      function normalizeChatProfile(profile, steamId, fallbackName = null) {
        const resolvedId = pickString(profile == null ? void 0 : profile.steamid, profile == null ? void 0 : profile.SteamId, steamId);
        const displayName = pickString(
          profile == null ? void 0 : profile.forced_display_name,
          profile == null ? void 0 : profile.forcedDisplayName,
          profile == null ? void 0 : profile.display_name,
          profile == null ? void 0 : profile.displayName,
          profile == null ? void 0 : profile.persona,
          profile == null ? void 0 : profile.personaName,
          profile == null ? void 0 : profile.personaname,
        ...
        const avatar = pickString(
          profile == null ? void 0 : profile.avatarfull,
          profile == null ? void 0 : profile.avatarFull,
          profile == null ? void 0 : profile.avatar,
          profile == null ? void 0 : profile.avatar_medium,
          profile == null ? void 0 : profile.avatarMedium,
          profile == null ? void 0 : profile.avatar_url,
          profile == null ? void 0 : profile.avatarUrl
        );
        const profileUrl = pickString(
          profile == null ? void 0 : profile.profileurl,
          profile == null ? void 0 : profile.profile_url,
          profile == null ? void 0 : profile.profileUrl
        );
        return {
      ...
      function chatAvatarInitial(name = "") {
        ...
        if (!text2) return "?";
        const code = text2.codePointAt(0);
        if (code == null) return "?";
      ...
      function renderChatMessages() {
        ...
        const filtered = chatState.filter === "all" ? records : records.filter((entry) => entry.channel === chatState.filter);
        ...
        workspaceChatEmpty == null ? void 0 : workspaceChatEmpty.classList.add("hidden");
        ...
        filtered.forEach((entry) => {
          ...
          const displayName = ((profile == null ? void 0 : profile.displayName) || entry.username || entry.steamId || "Unknown").trim();
          const avatarUrl = (profile == null ? void 0 : profile.avatar) || null;
          if (avatarUrl) {
          ...
          const nameEl = (profile == null ? void 0 : profile.profileUrl) ? document.createElement("a") : document.createElement("span");
          nameEl.className = "chat-entry-name";
          nameEl.textContent = displayName;
          if (profile == null ? void 0 : profile.profileUrl) {
      ...
      async function refreshChatForServer(serverId, { force = false } = {}) {
        ...
        try {
          ...
          const messages = Array.isArray(data == null ? void 0 : data.messages) ? data.messages : [];
      ...
      function parseCombatLogFallbackGroups(rawLine) {
        ...
        const segments = remainder.split(/\s{2,}/).map((segment) => segment.trim()).filter((segment) => segment);
        ...
        const attackerId = String(attackerIdRaw != null ? attackerIdRaw : "").trim();
        const targetId = String(targetIdRaw != null ? targetIdRaw : "").trim();
        if (!/^-?\d+$/.test(attackerId) || !/^-?\d+$/.test(targetId)) {
          return null;
        }
        const groups = {
          time: timeParts.value,
          attacker: (_a2 = attackerRaw == null ? void 0 : attackerRaw.trim()) != null ? _a2 : "",
          attackerId,
          target: (_b2 = targetRaw == null ? void 0 : targetRaw.trim()) != null ? _b2 : "",
          targetId,
          weapon: (_c = baseColumns[0]) != null ? _c : "",
          ammo: (_d = baseColumns[1]) != null ? _d : "",
          area: (_e = baseColumns[2]) != null ? _e : "",
          distance: distanceParts.value,
          distanceUnit: distanceParts.unit,
          oldHp: (_f = baseColumns[4]) != null ? _f : "",
          newHp: (_g = baseColumns[5]) != null ? _g : "",
          info: infoValue,
          hits: (_h = segments[tailStart]) != null ? _h : "",
          integrity: (_i = segments[tailStart + 1]) != null ? _i : "",
      ...
      function parseKillRawLog(raw) {
        ...
        if (!text2) return null;
        const victimPattern = new RegExp("^(?:\\[(?<victimClan>[^\\]]+)\\]\\s*)?(?<victimName>[^\\[]+?)\\[(?<victimSteamId>\\d+)\\]\\s+was killed by\\s+(?<killerPart>.+)$", "i");
        const victimMatch = text2.match(victimPattern);
        if (!(victimMatch == null ? void 0 : victimMatch.groups)) return null;
        const result = {
          victimName: ((_a2 = victimMatch.groups.victimName) == null ? void 0 : _a2.trim()) || null,
          victimClan: ((_b2 = victimMatch.groups.victimClan) == null ? void 0 : _b2.trim()) || null,
        ...
        const killerPattern = new RegExp("^(?:\\[(?<killerClan>[^\\]]+)\\]\\s*)?(?<killerName>.*?)(?:\\[(?<killerSteamId>\\d+)\\])?(?<rest>(?:\\s+.*)?)$", "i");
        const killerMatch = killerPart.match(killerPattern);
        let rest = "";
        if (killerMatch == null ? void 0 : killerMatch.groups) {
          result.killerName = ((_c = killerMatch.groups.killerName) == null ? void 0 : _c.trim()) || null;
          result.killerClan = ((_d = killerMatch.groups.killerClan) == null ? void 0 : _d.trim()) || null;
        ...
        const weaponPattern = new RegExp("\\b(?:using|with)\\s+(?<weapon>[^@]+?)(?:\\s+from\\b|\\s+at\\b|\\s*$)", "i");
        const weaponMatch = rest.match(weaponPattern);
        if ((_e = weaponMatch == null ? void 0 : weaponMatch.groups) == null ? void 0 : _e.weapon) {
          const weapon = weaponMatch.groups.weapon.trim();
          if (weapon) result.weapon = weapon;
        }
        const distancePattern = new RegExp("\\bfrom\\s+(?<distance>-?\\d+(?:\\.\\d+)?)\\s*m\\b", "i");
        const distanceMatch = rest.match(distancePattern);
        if ((_f = distanceMatch == null ? void 0 : distanceMatch.groups) == null ? void 0 : _f.distance) {
          const parsed = Number(distanceMatch.groups.distance);
          if (Number.isFinite(parsed)) result.distance = parsed;
        }
        const locationPattern = new RegExp("\\bat\\s*\\(\\s*(?<x>-?\\d+(?:\\.\\d+)?),\\s*(?<y>-?\\d+(?:\\.\\d+)?),\\s*(?<z>-?\\d+(?:\\.\\d+)?)\\s*\\)", "i");
        const locationMatch = rest.match(locationPattern);
        if (locationMatch == null ? void 0 : locationMatch.groups) {
          result.position = {
      ...
      function parseCombatLogEntries(lines) {
        ...
        const normalized = lines.map((line) => typeof line === "string" ? line : String(line != null ? line : "")).map((line) => line.replace(/\r/g, "")).map((line) => line.trimEnd()).filter((line) => line);
        ...
        for (let i = startIndex; i < normalized.length; i += 1) {
          ...
          const groups = (_a2 = match == null ? void 0 : match.groups) != null ? _a2 : parseCombatLogFallbackGroups(rawLine);
          if (!groups) continue;
      ...
      function normalizeKillEvent(raw, serverId) {
        ...
        if (!raw) return null;
        const resolvedServerId = Number((_b2 = (_a2 = raw == null ? void 0 : raw.serverId) != null ? _a2 : raw == null ? void 0 : raw.server_id) != null ? _b2 : serverId);
        if (!Number.isFinite(resolvedServerId)) return null;
        const occurredRaw = (_e = (_d = (_c = raw == null ? void 0 : raw.occurredAt) != null ? _c : raw == null ? void 0 : raw.occurred_at) != null ? _d : raw == null ? void 0 : raw.createdAt) != null ? _e : raw == null ? void 0 : raw.created_at;
        const occurredDate = occurredRaw ? new Date(occurredRaw) : /* @__PURE__ */ new Date();
        if (Number.isNaN(occurredDate.getTime())) return null;
        const toNumber = (value) => {
          const num2 = Number(value);
          return Number.isFinite(num2) ? num2 : null;
        };
        const rawLog = (_h = (_g = (_f = raw == null ? void 0 : raw.raw) != null ? _f : raw == null ? void 0 : raw.raw_log) != null ? _g : raw == null ? void 0 : raw.rawLog) != null ? _h : null;
        const parsedRaw = parseKillRawLog(rawLog);
        let combatLog = (_k = (_j = (_i = raw == null ? void 0 : raw.combatLog) != null ? _i : raw == null ? void 0 : raw.combat_log) != null ? _j : raw == null ? void 0 : raw.combat_log_json) != null ? _k : null;
        ...
        if (combatLog && typeof combatLog === "object") {
          const lines = Array.isArray(combatLog.lines) ? combatLog.lines.map((line) => String(line != null ? line : "")).map((line) => line.replace(/\r/g, "")).filter((line) => line) : typeof combatLog.text === "string" ? combatLog.text.replace(/\r/g, "").split("\n").map((line) => line.trimEnd()).filter((line) => line) : [];
          const limitedLines = lines.slice(0, 20);
          const limitedText = limitedLines.join("\n");
          combatLog = {
            text: limitedText,
            lines: limitedLines,
            fetchedAt: combatLog.fetchedAt || (/* @__PURE__ */ new Date()).toISOString()
          };
        ...
        const position = {
          x: toNumber((_n = (_m = (_l = raw == null ? void 0 : raw.position) == null ? void 0 : _l.x) != null ? _m : raw == null ? void 0 : raw.pos_x) != null ? _n : raw == null ? void 0 : raw.posX),
          y: toNumber((_q = (_p = (_o = raw == null ? void 0 : raw.position) == null ? void 0 : _o.y) != null ? _p : raw == null ? void 0 : raw.pos_y) != null ? _q : raw == null ? void 0 : raw.posY),
          z: toNumber((_t = (_s = (_r = raw == null ? void 0 : raw.position) == null ? void 0 : _r.z) != null ? _s : raw == null ? void 0 : raw.pos_z) != null ? _t : raw == null ? void 0 : raw.posZ)
        };
        let hasPosition = position.x != null || position.y != null || position.z != null;
        if (!hasPosition && (parsedRaw == null ? void 0 : parsedRaw.position)) {
        ...
        let distanceValue = toNumber(raw == null ? void 0 : raw.distance);
        if (distanceValue == null && (parsedRaw == null ? void 0 : parsedRaw.distance) != null) {
          distanceValue = toNumber(parsedRaw.distance);
        }
        const killerSteamId = pickString(raw == null ? void 0 : raw.killerSteamId, raw == null ? void 0 : raw.killer_steamid, parsedRaw == null ? void 0 : parsedRaw.killerSteamId);
        const killerName = pickString(raw == null ? void 0 : raw.killerName, raw == null ? void 0 : raw.killer_name, parsedRaw == null ? void 0 : parsedRaw.killerName);
        const killerClan = pickString(raw == null ? void 0 : raw.killerClan, raw == null ? void 0 : raw.killer_clan, parsedRaw == null ? void 0 : parsedRaw.killerClan);
        const victimSteamId = pickString(raw == null ? void 0 : raw.victimSteamId, raw == null ? void 0 : raw.victim_steamid, parsedRaw == null ? void 0 : parsedRaw.victimSteamId);
        const victimName = pickString(raw == null ? void 0 : raw.victimName, raw == null ? void 0 : raw.victim_name, parsedRaw == null ? void 0 : parsedRaw.victimName);
        const victimClan = pickString(raw == null ? void 0 : raw.victimClan, raw == null ? void 0 : raw.victim_clan, parsedRaw == null ? void 0 : parsedRaw.victimClan);
        let weapon = pickString(raw == null ? void 0 : raw.weapon, parsedRaw == null ? void 0 : parsedRaw.weapon);
        const rawWeapon = weapon;
        if ((_u = combatLog == null ? void 0 : combatLog.records) == null ? void 0 : _u.length) {
          for (let i = combatLog.records.length - 1; i >= 0; i -= 1) {
            const record = combatLog.records[i];
            const info = String((record == null ? void 0 : record.info) || "").toLowerCase();
            const isKillRecord = info.includes("killed") || (record == null ? void 0 : record.newHp) != null && Number.isFinite(record.newHp) && record.newHp <= 0;
            if (!isKillRecord) continue;
            if (record == null ? void 0 : record.weapon) {
              weapon = record.weapon;
            }
            if ((record == null ? void 0 : record.distanceMeters) != null && Number.isFinite(record.distanceMeters)) {
              distanceValue = record.distanceMeters;
            } else if (record == null ? void 0 : record.distanceRaw) {
        ...
        return {
          id: (_v = raw == null ? void 0 : raw.id) != null ? _v : null,
          ...
          raw: rawLog,
          combatLog,
          combatLogError: (_x = (_w = raw == null ? void 0 : raw.combatLogError) != null ? _w : raw == null ? void 0 : raw.combat_log_error) != null ? _x : null,
          createdAt: (_z = (_y = raw == null ? void 0 : raw.createdAt) != null ? _y : raw == null ? void 0 : raw.created_at) != null ? _z : occurredDate.toISOString()
        };
      }
      function killEventSignature(entry) {
        ...
        return [
          ...
          entry.killerSteamId || "",
          entry.victimSteamId || "",
          (_b2 = (_a2 = entry.rawWeapon) != null ? _a2 : entry.weapon) != null ? _b2 : "",
          entry.raw || ""
        ].join("::");
      }
      function killFeedRenderSignature(records) {
        return records.map((entry) => {
          ...
          const coords = entry.position ? ["x", "y", "z"].map((axis) => {
            var _a3;
            const value = Number((_a3 = entry.position) == null ? void 0 : _a3[axis]);
            return Number.isFinite(value) ? value.toFixed(3) : "";
          }).join(",") : "";
          const combatLogLines = Array.isArray((_a2 = entry.combatLog) == null ? void 0 : _a2.lines) ? entry.combatLog.lines.join("|") : ((_b2 = entry.combatLog) == null ? void 0 : _b2.text) || "";
          return [
      ...
      const COMBAT_LOG_TABLE_COLUMNS = [
        ...
        { key: "area", label: "Area", render: (record) => record.area || "\u2014" },
        {
          key: "distanceMeters",
          label: "Distance",
          render: (record) => Number.isFinite(record.distanceMeters) ? `${record.distanceMeters.toFixed(1)} m` : record.distanceRaw || "\u2014"
        },
        {
          key: "oldHp",
          label: "Old HP",
        ...
        },
        {
          key: "travelSeconds",
          label: "Travel",
          render: (record) => Number.isFinite(record.travelSeconds) ? `${record.travelSeconds.toFixed(2)} s` : record.travelRaw || "\u2014"
        },
        {
          key: "mismatchMeters",
          label: "Mismatch",
          render: (record) => Number.isFinite(record.mismatchMeters) ? `${record.mismatchMeters.toFixed(2)} m` : record.mismatchRaw || "\u2014"
        },
        {
          key: "desync",
          label: "Desync",
          ...
          if (seen.has(signature)) {
            for (let i = 0; i < list.length; i += 1) {
              if (killEventSignature(list[i]) === signature) {
                list[i] = __spreadValues(__spreadValues({}, list[i]), normalized);
                break;
              }
            }
            continue;
      ...
      function renderKillFeed() {
        ...
        killFeedEmpty == null ? void 0 : killFeedEmpty.classList.add("hidden");
        ...
        if (previousSignature === renderSignature && killFeedList.childElementCount > 0) {
          return;
        }
        const openSignatures = /* @__PURE__ */ new Set();
        killFeedList.querySelectorAll("li[data-signature]").forEach((item) => {
          var _a2;
          const signature = (_a2 = item == null ? void 0 : item.dataset) == null ? void 0 : _a2.signature;
          const detailsEl = item.querySelector("details");
          if (signature && (detailsEl == null ? void 0 : detailsEl.open)) {
        ...
        records.forEach((entry, index) => {
          ...
          const shouldOpen = openSignatures.size ? openSignatures.has(signature) : index === 0;
          ...
          if (entry.distance != null) {
            ...
            const distanceValue = Number(entry.distance);
            distanceEl.textContent = Number.isFinite(distanceValue) ? `${distanceValue.toFixed(1)} m` : `${entry.distance}`;
          ...
          if (entry.combatLog) {
            ...
            if (Array.isArray(entry.combatLog.records) && entry.combatLog.records.length) {
              ...
              const lines = Array.isArray(entry.combatLog.lines) && entry.combatLog.lines.length ? entry.combatLog.lines.join("\n") : entry.combatLog.text || "No combat log entries.";
      ...
      function handleIncomingKill(payload) {
        var _a2, _b2;
        if (!payload) return;
        const serverId = Number((_b2 = (_a2 = payload == null ? void 0 : payload.serverId) != null ? _a2 : payload == null ? void 0 : payload.server_id) != null ? _b2 : state.currentServerId);
        if (!Number.isFinite(serverId)) return;
        if (payload == null ? void 0 : payload.event) {
          storeKillEvents(serverId, [payload.event]);
        } else if (Array.isArray(payload == null ? void 0 : payload.events)) {
      ...
      function handleIncomingChat(payload) {
        ...
        const serverId = Number((_b2 = (_a2 = payload == null ? void 0 : payload.serverId) != null ? _a2 : payload == null ? void 0 : payload.server_id) != null ? _b2 : state.currentServerId);
        if (!Number.isFinite(serverId)) return;
        const content = (_d = (_c = payload == null ? void 0 : payload.message) != null ? _c : payload == null ? void 0 : payload.messages) != null ? _d : payload;
      ...
      function normalizeF7Report(report) {
        ...
        const serverId = Number((_b2 = (_a2 = report.serverId) != null ? _a2 : report.server_id) != null ? _b2 : f7State.serverId);
        const createdAt = pickString((_c = report.createdAt) != null ? _c : report.created_at) || null;
        const updatedAt = pickString((_d = report.updatedAt) != null ? _d : report.updated_at) || createdAt;
        return {
          id: Number.isFinite(id) ? id : null,
          serverId: Number.isFinite(serverId) ? serverId : f7State.serverId,
          reportId: pickString((_e = report.reportId) != null ? _e : report.report_id) || null,
          reporterSteamId: pickString((_f = report.reporterSteamId) != null ? _f : report.reporter_steamid) || null,
          reporterName: pickString((_g = report.reporterName) != null ? _g : report.reporter_name) || null,
          targetSteamId: pickString((_h = report.targetSteamId) != null ? _h : report.target_steamid) || null,
          targetName: pickString((_i = report.targetName) != null ? _i : report.target_name) || null,
      ...
      function normalizeAqTicket(ticket) {
        ...
        const id = Number((_a2 = ticket.id) != null ? _a2 : ticket.ticketId);
        const serverId = Number((_c = (_b2 = ticket.serverId) != null ? _b2 : ticket.server_id) != null ? _c : aqState.serverId);
        const teamId = Number((_e = (_d = ticket.teamId) != null ? _d : ticket.team_id) != null ? _e : state.activeTeamId);
        const ticketNumber = Number((_f = ticket.ticketNumber) != null ? _f : ticket.ticket_number);
        const createdAt = pickString((_g = ticket.createdAt) != null ? _g : ticket.created_at) || null;
        const updatedAt = pickString((_h = ticket.updatedAt) != null ? _h : ticket.updated_at) || createdAt;
        return {
          id: Number.isFinite(id) ? id : null,
          ...
          createdBy: pickString((_i = ticket.createdBy) != null ? _i : ticket.created_by) || null,
          createdByTag: pickString((_j = ticket.createdByTag) != null ? _j : ticket.created_by_tag) || null,
          status: pickString(ticket.status) || "open",
          createdAt,
          updatedAt,
          closedAt: pickString((_k = ticket.closedAt) != null ? _k : ticket.closed_at) || null,
          closedBy: pickString((_l = ticket.closedBy) != null ? _l : ticket.closed_by) || null,
          closedByTag: pickString((_m = ticket.closedByTag) != null ? _m : ticket.closed_by_tag) || null,
          closeReason: pickString((_n = ticket.closeReason) != null ? _n : ticket.close_reason) || null,
          previewToken: pickString((_o = ticket.previewToken) != null ? _o : ticket.preview_token) || null,
          previewUrl: pickString((_r = (_q = (_p = ticket.previewUrl) != null ? _p : ticket.preview_url) != null ? _q : ticket.previewPath) != null ? _r : ticket.preview_path) || null
        };
      }
      function normalizeAqDialogEntry(entry) {
        ...
        const postedAt = pickString((_a2 = entry.postedAt) != null ? _a2 : entry.timestamp) || null;
        const content = pickString(entry.content) || "";
        const authorTag = pickString((_c = (_b2 = entry.authorTag) != null ? _b2 : entry.author_tag) != null ? _c : entry.author) || null;
        const authorId = pickString((_d = entry.authorId) != null ? _d : entry.author_id) || null;
        return {
      ...
      function normaliseF7FilterTokens(value) {
        ...
        if (!text2) return [];
        return text2.split(/\s+/).map((token) => token.trim()).filter(Boolean);
      }
      ...
      function matchF7Token(report, token) {
        ...
        if (raw.includes(":")) {
          ...
          if (parts.length >= 2) {
            key = ((_a2 = parts[0]) == null ? void 0 : _a2.trim().toLowerCase()) || null;
            value = ((_b2 = parts[1]) == null ? void 0 : _b2.trim()) || "";
          }
        }
      ...
      function updateF7ScopeButtons() {
        ...
        f7ScopeButtons.forEach((btn) => {
          var _a2;
          if (!btn) return;
          const btnScope = ((_a2 = btn.dataset) == null ? void 0 : _a2.scope) || "new";
      ...
      function renderF7FocusBanner() {
        ...
        if (focusActive) {
          ...
          if (f7ReportsFocusLabel) {
            f7ReportsFocusLabel.textContent = label ? `Showing reports for ${label}` : "Showing reports for selected player";
          }
          if (f7ReportsClearFocus) {
      ...
      function focusF7ReportsOnTarget(steamId, label) {
        var _a2, _b2;
        const id = (_a2 = pickString(steamId)) == null ? void 0 : _a2.trim();
        if (!id) return;
        const name = ((_b2 = pickString(label)) == null ? void 0 : _b2.trim()) || "";
      ...
      function renderF7ReportDetail(detail) {
        ...
        if (!detail) {
          ...
          if (!Number.isFinite(f7State.serverId)) {
            ...
            f7ReportPlaceholder.textContent = focusActive ? "No reports found for this player yet." : "Select a report to review the details.";
            f7ReportPlaceholder.classList.remove("hidden");
          } else if (f7State.loading) {
            f7ReportPlaceholder.textContent = focusActive ? "Loading player report history\u2026" : "Loading reports\u2026";
            f7ReportPlaceholder.classList.remove("hidden");
          } else {
            f7ReportPlaceholder.classList.remove("hidden");
            f7ReportPlaceholder.textContent = focusActive ? "Select a report to review this player's history." : "Select a report to review the details.";
          }
          return;
        }
        ...
        if (f7ReportShowAll) {
          const steamId = (_a2 = pickString(detail.targetSteamId)) == null ? void 0 : _a2.trim();
      ...
      function renderF7Reports() {
        ...
        const normalised = baseList.map((item) => normalizeF7Report(item)).filter(Boolean).sort((a, b) => {
        ...
        for (const report of normalised) {
          if ((report == null ? void 0 : report.id) != null) {
        ...
        const visible = filterTokens.length > 0 ? deduped.filter((report) => matchesF7Filter(report, filterTokens)) : deduped;
        ...
        if (f7ReportsCount) {
          if (!hasServer) {
            ...
            f7ReportsCount.textContent = focusActive ? focusLabel ? `No reports for ${focusLabel}` : "No reports for selected player" : "No reports";
          } else if (filterTokens.length > 0) {
            const label = deduped.length === 1 ? "report" : "reports";
            const suffix = focusActive ? focusLabel ? ` ${label} for ${focusLabel}` : ` ${label} for selected player` : ` ${label}`;
            f7ReportsCount.textContent = `Showing ${visible.length} of ${deduped.length}${suffix}`;
          } else {
            const label = deduped.length === 1 ? "report" : "reports";
            if (focusActive) {
              f7ReportsCount.textContent = focusLabel ? `${deduped.length} ${label} for ${focusLabel}` : `${deduped.length} ${label} for selected player`;
            } else {
        ...
        if (f7ReportsEmpty) {
          ...
          if (showFilteredEmpty) {
            f7ReportsEmpty.textContent = focusActive ? "No reports for this player match your filter." : "No reports match your filter.";
          } else if (focusActive) {
            f7ReportsEmpty.textContent = focusLabel ? `No reports found for ${focusLabel}.` : "No reports found for this player yet.";
          } else {
        ...
        if (f7State.activeId == null || !visible.some((item) => item.id === f7State.activeId)) {
          f7State.activeId = (_b2 = (_a2 = visible[0]) == null ? void 0 : _a2.id) != null ? _b2 : null;
        }
        const detail = f7State.activeId != null ? f7State.detailCache.get(f7State.activeId) : null;
      ...
      function formatCountryDetail(name, code) {
        ...
        const upper = ((_a2 = pickString(code)) == null ? void 0 : _a2.toUpperCase()) || null;
      ...
      function renderF7TargetSummary(summary) {
        ...
        if (f7ReportSummaryTotal) f7ReportSummaryTotal.textContent = formatNumber((_b2 = (_a2 = summary.totalReports) != null ? _a2 : summary.total_reports) != null ? _b2 : 0);
        if (f7ReportSummaryRecent) f7ReportSummaryRecent.textContent = formatNumber((_d = (_c = summary.recentReports) != null ? _c : summary.recent_reports) != null ? _d : 0);
        if (f7ReportSummaryReporters) f7ReportSummaryReporters.textContent = formatNumber((_f = (_e = summary.reporterCount) != null ? _e : summary.reporter_count) != null ? _f : 0);
        if (f7ReportSummaryFirst) f7ReportSummaryFirst.textContent = formatAbsoluteWithRelative((_g = summary.firstReportedAt) != null ? _g : summary.first_report_at);
        if (f7ReportSummaryLast) f7ReportSummaryLast.textContent = formatAbsoluteWithRelative((_h = summary.lastReportedAt) != null ? _h : summary.last_report_at);
        if (f7ReportSummaryRecentLabel) {
          const label = describeRecentWindow((_i = summary.recentWindowMs) != null ? _i : summary.recent_window_ms);
        ...
        if (f7ReportSummaryCategories) {
          ...
          const categories = Array.isArray((_j = summary.topCategories) != null ? _j : summary.top_categories) ? (_k = summary.topCategories) != null ? _k : summary.top_categories : [];
          categories.filter(Boolean).forEach((entry) => {
            var _a3;
            const category = pickString(entry.category, entry.name) || "Unspecified";
            const count = Number((_a3 = entry.count) != null ? _a3 : entry.total) || 0;
            const tag = document.createElement("span");
            tag.className = "tag";
            tag.textContent = `${category} \xB7 ${formatNumber(count)}`;
      ...
      function normalizeF7PlayerProfile(data, steamId, fallbackName) {
        var _a2, _b2, _c, _d, _e, _f, _g, _h;
        const resolvedId = pickString(data == null ? void 0 : data.steamid, data == null ? void 0 : data.steamId, steamId);
        const forcedName = pickString(data == null ? void 0 : data.forced_display_name, data == null ? void 0 : data.forcedDisplayName);
        const persona = pickString(
          forcedName,
          data == null ? void 0 : data.display_name,
          data == null ? void 0 : data.displayName,
          data == null ? void 0 : data.persona,
          data == null ? void 0 : data.personaName,
          fallbackName,
          resolvedId
        );
        const rawDisplay = pickString(data == null ? void 0 : data.raw_display_name, data == null ? void 0 : data.rawDisplayName, persona, fallbackName, resolvedId);
        const profileUrl = pickString(data == null ? void 0 : data.profileurl, data == null ? void 0 : data.profile_url, data == null ? void 0 : data.profileUrl) || (resolvedId ? `https://steamcommunity.com/profiles/${resolvedId}` : null);
        const avatarFull = pickString(data == null ? void 0 : data.avatarfull, data == null ? void 0 : data.avatarFull, data == null ? void 0 : data.avatar);
        const countryCode = pickString(data == null ? void 0 : data.country);
        const ipCountryCode = pickString(data == null ? void 0 : data.ip_country_code, data == null ? void 0 : data.ipCountryCode);
        const ipCountryName = pickString(data == null ? void 0 : data.ip_country_name, data == null ? void 0 : data.ipCountryName);
        const vacBanned = Number((_a2 = data == null ? void 0 : data.vac_banned) != null ? _a2 : data == null ? void 0 : data.vacBanned) > 0 ? 1 : 0;
        const gameBans = Number((_c = (_b2 = data == null ? void 0 : data.game_bans) != null ? _b2 : data == null ? void 0 : data.gameBans) != null ? _c : 0) || 0;
        const lastBanDays = Number((_e = (_d = data == null ? void 0 : data.last_ban_days) != null ? _d : data == null ? void 0 : data.lastBanDays) != null ? _e : data == null ? void 0 : data.daysSinceLastBan);
        const playtimeMinutes = Number(
          (_h = (_g = (_f = data == null ? void 0 : data.rust_playtime_minutes) != null ? _f : data == null ? void 0 : data.rustPlaytimeMinutes) != null ? _g : data == null ? void 0 : data.total_playtime_minutes) != null ? _h : data == null ? void 0 : data.totalPlaytimeMinutes
        );
        return {
          ...
          playtime_updated_at: pickString(data == null ? void 0 : data.playtime_updated_at, data == null ? void 0 : data.playtimeUpdatedAt) || null,
      ...
      function renderF7TargetProfile(detail) {
        ...
        const steamId = pickString(detail == null ? void 0 : detail.targetSteamId);
        if (!detail || !steamId) {
        ...
        const profile = (cacheEntry == null ? void 0 : cacheEntry.profile) || null;
        const loading = !profile && f7ProfileRequests.has(steamId.trim());
        const errorMessage = cacheEntry == null ? void 0 : cacheEntry.error;
        const displayName = pickString(
          profile == null ? void 0 : profile.display_name,
          profile == null ? void 0 : profile.persona,
          detail.targetName,
        ...
        if (f7ReportProfileAvatar) {
          ...
          const avatarUrl = (profile == null ? void 0 : profile.avatarfull) || (profile == null ? void 0 : profile.avatar) || null;
          if (avatarUrl) {
            const img = document.createElement("img");
            img.src = avatarUrl;
        ...
        if (f7ReportProfileCountry) {
          const steamCountry = (profile == null ? void 0 : profile.country) || null;
          const ipCountryCode = (profile == null ? void 0 : profile.ip_country_code) || null;
          const ipCountryName = (profile == null ? void 0 : profile.ip_country_name) || null;
          const parts = [];
          ...
          const ipLabel = ipCountryCode || ipCountryName ? formatCountryDetail(ipCountryName || describeCountry(ipCountryCode), ipCountryCode) : null;
          if (ipLabel) parts.push(`IP: ${ipLabel}`);
          f7ReportProfileCountry.textContent = parts.length ? parts.join(" \xB7 ") : "\u2014";
        }
        if (f7ReportProfileVac) {
          const vac = Number(profile == null ? void 0 : profile.vac_banned) > 0;
          f7ReportProfileVac.textContent = vac ? "VAC ban on record" : "None";
        }
        if (f7ReportProfileGameBans) {
          const bans = Number(profile == null ? void 0 : profile.game_bans) || 0;
          f7ReportProfileGameBans.textContent = bans > 0 ? `${formatNumber(bans)}` : "0";
        }
        if (f7ReportProfileLastBan) {
          f7ReportProfileLastBan.textContent = describeBanAge(profile == null ? void 0 : profile.last_ban_days, Number(profile == null ? void 0 : profile.vac_banned) > 0, Number(profile == null ? void 0 : profile.game_bans) || 0);
        }
        if (f7ReportProfilePlaytime) {
          f7ReportProfilePlaytime.textContent = formatPlaytimeMinutes(profile == null ? void 0 : profile.rust_playtime_minutes);
          const updated = profile == null ? void 0 : profile.playtime_updated_at;
          if (updated) {
      ...
      function buildF7PlayerPayload(detail) {
        ...
        const baseName = pickString(
          (_a2 = cached == null ? void 0 : cached.profile) == null ? void 0 : _a2.display_name,
          detail.targetName,
          steamId
        ) || steamId;
        const payload = __spreadValues({}, (cached == null ? void 0 : cached.profile) || {});
      ...
      async function refreshF7Reports({ force = false } = {}) {
        ...
        try {
          ...
          const list = Array.isArray(data == null ? void 0 : data.reports) ? data.reports.map((item) => normalizeF7Report(item)).filter(Boolean) : [];
          if (f7State.listRequestToken === requestToken && Number(f7State.serverId) === serverId) {
            ...
            if (list.length && (f7State.activeId == null || !list.some((item) => item.id === f7State.activeId))) {
              f7State.activeId = (_b2 = (_a2 = list[0]) == null ? void 0 : _a2.id) != null ? _b2 : null;
            }
            f7State.error = null;
          }
        } catch (err) {
      ...
      async function loadF7ReportDetail(reportId, { force = false } = {}) {
        ...
        try {
          ...
          const baseReport = normalizeF7Report(data == null ? void 0 : data.report);
          const previous = f7State.detailCache.get(numericId) || {};
          const detail = __spreadProps(__spreadValues({}, baseReport), {
            recentForTarget: Array.isArray(data == null ? void 0 : data.recentForTarget) ? data.recentForTarget.map((item) => normalizeF7Report(item)).filter(Boolean) : [],
            targetSummary: (_b2 = (_a2 = data == null ? void 0 : data.targetSummary) != null ? _a2 : previous.targetSummary) != null ? _b2 : null
          });
      ...
      function renderAqTickets() {
        ...
        list.forEach((ticket) => {
          ...
          const createdLabel = normalized.createdAt ? formatRelativeTime(normalized.createdAt) || formatDateTime(normalized.createdAt) : null;
          if (statusLower === "closed") {
            const closedWhen = normalized.closedAt ? formatRelativeTime(normalized.closedAt) || formatDateTime(normalized.closedAt) : null;
      ...
      function renderAqTicketReply(detail) {
        ...
        const isClosed = ((ticket == null ? void 0 : ticket.status) || "").toLowerCase() === "closed";
        const sending = aqState.replying;
        const message = (aqTicketReplyInput == null ? void 0 : aqTicketReplyInput.value) || "";
      ...
      function renderAqTicketDetail(detail) {
        ...
        if (!activeDetail) {
          ...
          if (aqTicketPlaceholder) {
            if (!hasServer) {
              ...
              aqTicketPlaceholder.textContent = aqState.list.length > 0 ? "Select a ticket to view the conversation." : "No tickets for this server yet.";
            }
            aqTicketPlaceholder.classList.remove("hidden");
          }
        ...
        const ticket = normalizeAqTicket(activeDetail.ticket);
        if (aqTicketSubject) {
          aqTicketSubject.textContent = (ticket == null ? void 0 : ticket.subject) || "No subject provided";
        }
        if (aqTicketNumber) {
          aqTicketNumber.textContent = (ticket == null ? void 0 : ticket.ticketNumber) != null ? `#${ticket.ticketNumber}` : "";
        }
        if (aqTicketMeta) {
          const statusLower = ((ticket == null ? void 0 : ticket.status) || "").toLowerCase();
          if (statusLower === "closed") {
            const closedWhen = (ticket == null ? void 0 : ticket.closedAt) ? formatRelativeTime(ticket.closedAt) || formatDateTime(ticket.closedAt) : "Unknown time";
            const closedBy = (ticket == null ? void 0 : ticket.closedByTag) || (ticket == null ? void 0 : ticket.closedBy) || "Unknown staff";
            const openedWhen = (ticket == null ? void 0 : ticket.createdAt) ? formatRelativeTime(ticket.createdAt) || formatDateTime(ticket.createdAt) : null;
            const opener = (ticket == null ? void 0 : ticket.createdByTag) || (ticket == null ? void 0 : ticket.createdBy) || "Unknown requester";
            const closedText = `Closed ${closedWhen} by ${closedBy}`;
            const openedText = openedWhen ? `Opened ${openedWhen} by ${opener}` : `Opened by ${opener}`;
            aqTicketMeta.textContent = `${closedText} \u2022 ${openedText}`;
          } else {
            const statusLabelRaw = (ticket == null ? void 0 : ticket.status) || "open";
            const statusLabel = statusLabelRaw.toLowerCase() === "open" ? "Open ticket" : statusLabelRaw.replace(/^[a-z]/, (char) => char.toUpperCase());
            const opener = (ticket == null ? void 0 : ticket.createdByTag) || (ticket == null ? void 0 : ticket.createdBy) || "Unknown requester";
            const when = (ticket == null ? void 0 : ticket.createdAt) ? formatRelativeTime(ticket.createdAt) || formatDateTime(ticket.createdAt) : "Unknown time";
            aqTicketMeta.textContent = `${statusLabel} \u2022 Opened ${when} by ${opener}`;
          }
        }
        if (aqTicketPreviewLink) {
          const previewUrl = (activeDetail == null ? void 0 : activeDetail.previewUrl) || (ticket == null ? void 0 : ticket.previewUrl) || null;
          if (previewUrl) {
      ...
      async function refreshAqTickets({ force = false } = {}) {
        ...
        try {
          ...
          const list = Array.isArray(data == null ? void 0 : data.tickets) ? data.tickets.map((item) => normalizeAqTicket(item)).filter(Boolean) : [];
          aqState.list = list;
          if (list.length === 0) {
            aqState.selectedId = null;
          } else if (aqState.selectedId == null || !list.some((ticket) => ticket.id === aqState.selectedId)) {
            aqState.selectedId = (_b2 = (_a2 = list[0]) == null ? void 0 : _a2.id) != null ? _b2 : null;
          }
          aqState.listError = null;
        } catch (err) {
          if (errorCode(err) === "unauthorized") handleUnauthorized();
      ...
      async function loadAqTicketDetail(ticketId, { force = false } = {}) {
        ...
        try {
          ...
          const ticket = normalizeAqTicket(data == null ? void 0 : data.ticket);
          const dialog = Array.isArray(data == null ? void 0 : data.dialog) ? data.dialog.map((entry) => normalizeAqDialogEntry(entry)).filter((entry) => entry && entry.content) : [];
          const previewUrl = pickString((_c = (_b2 = (_a2 = data == null ? void 0 : data.previewUrl) != null ? _a2 : data == null ? void 0 : data.preview_url) != null ? _b2 : ticket == null ? void 0 : ticket.previewUrl) != null ? _c : null) || null;
      ...
      aqTicketReplyForm == null ? void 0 : aqTicketReplyForm.addEventListener("submit", submitAqTicketReply);
      aqTicketReplyInput == null ? void 0 : aqTicketReplyInput.addEventListener("input", () => {
        if (aqState.replyError) {
          aqState.replyError = null;
        }
        renderAqTicketReply(getActiveAqTicketDetail());
      });
      discordStatusForm == null ? void 0 : discordStatusForm.addEventListener("submit", handleDiscordStatusSubmit);
      discordStatusServerSelect == null ? void 0 : discordStatusServerSelect.addEventListener("change", handleDiscordStatusServerChange);
      ...
      discordTicketingEnabledInput == null ? void 0 : discordTicketingEnabledInput.addEventListener("change", updateTeamTicketingState);
      discordTicketingPingInput == null ? void 0 : discordTicketingPingInput.addEventListener("change", updateTeamTicketingState);
      ticketingInputs.forEach((input) => {
        input == null ? void 0 : input.addEventListener("input", updateTeamTicketingState);
      });
      ticketingSelectBindings.forEach(([select2, input]) => {
        select2 == null ? void 0 : select2.addEventListener("change", () => {
          if (input) input.value = select2.value;
          updateTeamTicketingState();
        });
      });
      commandRoleControls.forEach(({ key, input, select: select2, list }) => {
        ...
        input == null ? void 0 : input.addEventListener("change", commitInput);
        input == null ? void 0 : input.addEventListener("blur", commitInput);
        select2 == null ? void 0 : select2.addEventListener("change", () => handleCommandRoleSelect(key, select2.value));
        list == null ? void 0 : list.addEventListener("click", (ev) => {
          var _a2, _b2;
          const target = (_b2 = (_a2 = ev.target) == null ? void 0 : _a2.closest) == null ? void 0 : _b2.call(_a2, "[data-remove-command-role]");
          if (!target) return;
          ev.preventDefault();
          removeCommandRole(target.dataset.commandRole, target.dataset.roleId);
        });
      });
      btnRefreshTeamCommandRoles == null ? void 0 : btnRefreshTeamCommandRoles.addEventListener("click", () => {
      ...
      if (typeof window !== "undefined") {
        window.addEventListener("workspace:server-selected", (event) => {
          var _a2, _b2;
          const id = Number((_a2 = event == null ? void 0 : event.detail) == null ? void 0 : _a2.serverId);
          if (!Number.isFinite(id)) return;
          if (Number(aqState.serverId) === id) {
            if ((_b2 = event == null ? void 0 : event.detail) == null ? void 0 : _b2.repeat) {
              refreshAqTickets({ force: true }).catch(() => {
              });
            }
            return;
        ...
        window.addEventListener("workspace:server-selected", (event) => {
          ...
          const id = Number((_a2 = event == null ? void 0 : event.detail) == null ? void 0 : _a2.serverId);
          if (!Number.isFinite(id)) return;
          const force = Boolean((_b2 = event == null ? void 0 : event.detail) == null ? void 0 : _b2.repeat);
        ...
        window.addEventListener("workspace:server-status", (event) => {
          ...
          setWorkspaceDiscordStatus(((_b2 = event == null ? void 0 : event.detail) == null ? void 0 : _b2.status) || null);
      ...
      function handleIncomingF7Report(payload) {
        ...
        if (f7State.focusTarget) {
          const targetId = (_a2 = pickString(report.targetSteamId)) == null ? void 0 : _a2.trim();
          if (!targetId || targetId !== f7State.focusTarget) {
            return;
          }
        }
        if (report.id != null) {
          f7State.detailCache.set(report.id, __spreadProps(__spreadValues({}, report), { recentForTarget: [], targetSummary: null }));
        }
        ...
        if (shouldTrack) {
          const matchesReport = (item) => {
            ...
            return !!report.createdAt && report.createdAt === item.createdAt && report.reporterSteamId === item.reporterSteamId && report.targetSteamId === item.targetSteamId;
          };
      ...
      function currentUserPermissions() {
        var _a2;
        return ((_a2 = state.currentUser) == null ? void 0 : _a2.permissions) || {};
      }
      ...
      function isSuperuser() {
        var _a2;
        return Boolean((_a2 = state.currentUser) == null ? void 0 : _a2.superuser);
      }
      ...
      function syncServerPermissions(servers = []) {
        ...
        for (const server of Array.isArray(servers) ? servers : []) {
          const id = server == null ? void 0 : server.id;
          if (id == null) continue;
          const key = toKey(id);
        ...
        state.currentUser.permissions = __spreadProps(__spreadValues({}, current), {
          servers: __spreadProps(__spreadValues({}, serverPerms), {
            allowed: nextAllowed
          })
        });
      ...
      const userDetailsDateFormatter = new Intl.DateTimeFormat(void 0, {
        dateStyle: "medium",
        timeStyle: "short"
      });
      function setProfileMenuOpen(open) {
        ...
        profileMenuTrigger == null ? void 0 : profileMenuTrigger.setAttribute("aria-expanded", active ? "true" : "false");
        brandAccount == null ? void 0 : brandAccount.classList.toggle("menu-open", active);
        if (active) {
      ...
      function applyTeamContext(context = {}) {
        ...
        if (Array.isArray(context.teams)) {
          state.teams = context.teams.map((team) => __spreadValues({}, team));
        }
        ...
        if (state.teamDiscord) {
          ...
          if (context.teamDiscord && typeof context.teamDiscord === "object") {
            ...
            state.teamDiscord.guildId = context.teamDiscord.guildId != null && context.teamDiscord.guildId !== "" ? String(context.teamDiscord.guildId) : null;
            state.teamDiscord.tokenPreview = context.teamDiscord.tokenPreview != null && context.teamDiscord.tokenPreview !== "" ? String(context.teamDiscord.tokenPreview) : null;
            state.teamDiscord.loadedTeamId = (_a2 = state.activeTeamId) != null ? _a2 : null;
            ...
            if (typeof context.activeTeamDiscordGuildId !== "undefined") {
              state.teamDiscord.guildId = context.activeTeamDiscordGuildId != null && context.activeTeamDiscordGuildId !== "" ? String(context.activeTeamDiscordGuildId) : null;
            }
            ...
            state.teamDiscord.loadedTeamId = (_b2 = state.activeTeamId) != null ? _b2 : null;
            appliedFromContext = true;
          }
        ...
        if (state.teamAuth) {
          ...
          if (context.teamAuth && typeof context.teamAuth === "object") {
            ...
            state.teamAuth.roleId = context.teamAuth.roleId != null && context.teamAuth.roleId !== "" ? String(context.teamAuth.roleId) : null;
            state.teamAuth.logChannelId = context.teamAuth.logChannelId != null && context.teamAuth.logChannelId !== "" ? String(context.teamAuth.logChannelId) : null;
            state.teamAuth.loaded = true;
            state.teamAuth.loadedTeamId = (_c = state.activeTeamId) != null ? _c : null;
            ...
            if (typeof context.activeTeamDiscordRoleId !== "undefined") {
              state.teamAuth.roleId = context.activeTeamDiscordRoleId != null && context.activeTeamDiscordRoleId !== "" ? String(context.activeTeamDiscordRoleId) : null;
            }
            ...
            state.teamAuth.loaded = true;
            state.teamAuth.loadedTeamId = (_d = state.activeTeamId) != null ? _d : null;
            appliedAuthContext = true;
          }
          if (state.activeTeamId !== previousTeamId) {
      ...
      function renderTeamSwitcher() {
        ...
        teamSelect.innerHTML = "";
        const currentUserId = Number((_a2 = state.currentUser) == null ? void 0 : _a2.id);
        const hasCurrentUserId = Number.isFinite(currentUserId);
        const currentUsername = typeof ((_b2 = state.currentUser) == null ? void 0 : _b2.username) === "string" ? state.currentUser.username.trim() : "";
        teams.forEach((team) => {
          var _a3, _b3;
          if (!team) return;
          const option = document.createElement("option");
          option.value = String(team.id);
          const ownerId = Number((_b3 = (_a3 = team.ownerId) != null ? _a3 : team.owner_id) != null ? _b3 : team.owner_user_id);
      ...
      async function refreshUserContext() {
        ...
        try {
          ...
          state.currentUser = {
            ...
            activeTeamId: (_a2 = me.activeTeamId) != null ? _a2 : null,
        ...
        return new Promise((resolve) => {
          ...
          if (dialogModal) {
            ...
            requestAnimationFrame(() => {
              ...
              else dialogConfirmBtn == null ? void 0 : dialogConfirmBtn.focus();
            });
          }
      ...
      async function confirmDialog(options = {}) {
        ...
        return !!(result == null ? void 0 : result.confirmed);
      }
      async function promptDialog(options = {}) {
        ...
        const result = await openDialog({
          ...
          cancelText: (_a2 = options.cancelText) != null ? _a2 : "Cancel",
        ...
        if (!(result == null ? void 0 : result.confirmed)) return null;
        return result.value != null ? result.value : "";
      }
      dialogOverlay == null ? void 0 : dialogOverlay.addEventListener("click", (event) => {
        if (event.target === dialogOverlay) cancelDialog();
      });
      dialogCancelBtn == null ? void 0 : dialogCancelBtn.addEventListener("click", (event) => {
        event.preventDefault();
        cancelDialog();
      });
      dialogModal == null ? void 0 : dialogModal.addEventListener("submit", (event) => {
        event.preventDefault();
        if (!dialogState.open) return;
      ...
      dialogInput == null ? void 0 : dialogInput.addEventListener("input", () => {
        if (dialogState.open) setDialogError("");
      });
      function renderUserDetails(user) {
        var _a2;
        if (!userDetailsPanel || !user) return;
        const isSelf = user.id === ((_a2 = state.currentUser) == null ? void 0 : _a2.id);
        const roleLabel = formatUserRole(user);
        if (userDetailsName) {
          const baseName = user.username || "\u2014";
          userDetailsName.textContent = roleLabel && roleLabel !== "\u2014" ? `${baseName} (${roleLabel})` : baseName;
        }
        if (userDetailsSubtitle) {
          userDetailsSubtitle.textContent = isSelf ? "Signed in with this account" : "Review access and credentials";
        }
      ...
      function openUserDetails(user) {
        ...
        activeUserDetails = __spreadValues({}, user);
        ...
        requestAnimationFrame(() => {
          userDetailsPanel == null ? void 0 : userDetailsPanel.focus();
        });
      }
      function closeUserDetails() {
        ...
        if (lastUserDetailsTrigger && document.body.contains(lastUserDetailsTrigger)) {
          requestAnimationFrame(() => lastUserDetailsTrigger == null ? void 0 : lastUserDetailsTrigger.focus());
        }
      ...
      async function handleUserDetailsRoleSave() {
        ...
        try {
          ...
          activeUserDetails = __spreadProps(__spreadValues({}, activeUserDetails), {
            role: selected,
            roleName: (roleDef == null ? void 0 : roleDef.name) || selected
          });
      ...
      userDetailsOverlay == null ? void 0 : userDetailsOverlay.addEventListener("click", (event) => {
        if (event.target === userDetailsOverlay) {
          closeUserDetails();
        }
      });
      userDetailsClose == null ? void 0 : userDetailsClose.addEventListener("click", () => {
        closeUserDetails();
      });
      ...
      userDetailsSaveRole == null ? void 0 : userDetailsSaveRole.addEventListener("click", handleUserDetailsRoleSave);
      userDetailsResetPassword == null ? void 0 : userDetailsResetPassword.addEventListener("click", handleUserDetailsPasswordReset);
      userDetailsDelete == null ? void 0 : userDetailsDelete.addEventListener("click", handleUserDetailsDelete);
          ...
          emit(event, payload) {
            ...
            for (const fn of [...set]) {
              try {
                ...
                console.error("Module handler error for", event, err);
              }
            }
          }
        };
      ...
      if (typeof window !== "undefined") {
        window.addEventListener("players:list", (event) => handlePlayersListUpdate((event == null ? void 0 : event.detail) || {}));
        window.addEventListener("map:team-colors", (event) => handleTeamColorsUpdate((event == null ? void 0 : event.detail) || {}));
      }
      const quickCommands = /* @__PURE__ */ new Map();
      ...
      function applyPermissionGates() {
        ...
        if (!canManageServers) {
          ...
          addServerCard == null ? void 0 : addServerCard.classList.add("hidden");
        ...
        if (quickCommandsEl) {
          ...
          quickCommandsEl.querySelectorAll("button").forEach((btn) => {
            btn.disabled = !hasCommands;
          });
        }
      ...
      function switchPanel(panel = "dashboard") {
        ...
        const fallbackPanel = adminOnlyMode ? canAccessAdmin ? "admin" : canAccessSettings ? "settings" : "dashboard" : "dashboard";
        let nextPanel = adminOnlyMode ? panel === "settings" ? "settings" : "admin" : panel;
        if (nextPanel === "team" && !canAccessTeam || nextPanel === "discord" && !canAccessDiscord || nextPanel === "linked" && !canAccessLinked || nextPanel === "admin" && !canAccessAdmin) {
        ...
        if (isSettings) {
          ...
          const locationHref = typeof window !== "undefined" ? (_a2 = window.location) == null ? void 0 : _a2.href : "(no-window)";
          ...
          dashboardPanel == null ? void 0 : dashboardPanel.classList.add("hidden");
          workspacePanel == null ? void 0 : workspacePanel.classList.add("hidden");
          teamPanel == null ? void 0 : teamPanel.classList.add("hidden");
          adminPanel == null ? void 0 : adminPanel.classList.add("hidden");
          discordPanel == null ? void 0 : discordPanel.classList.add("hidden");
          linkedAccountsPanel == null ? void 0 : linkedAccountsPanel.classList.add("hidden");
          ...
          adminPanel == null ? void 0 : adminPanel.classList.add("hidden");
          linkedAccountsPanel == null ? void 0 : linkedAccountsPanel.classList.add("hidden");
          discordPanel == null ? void 0 : discordPanel.classList.remove("hidden");
        } else if (isTeam) {
          dashboardPanel == null ? void 0 : dashboardPanel.classList.add("hidden");
          workspacePanel == null ? void 0 : workspacePanel.classList.add("hidden");
          settingsPanel == null ? void 0 : settingsPanel.classList.add("hidden");
          ...
          adminPanel == null ? void 0 : adminPanel.classList.add("hidden");
          linkedAccountsPanel == null ? void 0 : linkedAccountsPanel.classList.add("hidden");
          teamPanel == null ? void 0 : teamPanel.classList.remove("hidden");
        } else if (isAdmin) {
          dashboardPanel == null ? void 0 : dashboardPanel.classList.add("hidden");
          workspacePanel == null ? void 0 : workspacePanel.classList.add("hidden");
          settingsPanel == null ? void 0 : settingsPanel.classList.add("hidden");
          ...
          linkedAccountsPanel == null ? void 0 : linkedAccountsPanel.classList.add("hidden");
          teamPanel == null ? void 0 : teamPanel.classList.add("hidden");
          adminPanel == null ? void 0 : adminPanel.classList.remove("hidden");
        } else if (isLinked) {
          dashboardPanel == null ? void 0 : dashboardPanel.classList.add("hidden");
          workspacePanel == null ? void 0 : workspacePanel.classList.add("hidden");
          settingsPanel == null ? void 0 : settingsPanel.classList.add("hidden");
          ...
          adminPanel == null ? void 0 : adminPanel.classList.add("hidden");
          discordPanel == null ? void 0 : discordPanel.classList.add("hidden");
          linkedAccountsPanel == null ? void 0 : linkedAccountsPanel.classList.remove("hidden");
        } else {
          dashboardPanel == null ? void 0 : dashboardPanel.classList.remove("hidden");
          workspacePanel == null ? void 0 : workspacePanel.classList.add("hidden");
          settingsPanel == null ? void 0 : settingsPanel.classList.add("hidden");
          teamPanel == null ? void 0 : teamPanel.classList.add("hidden");
          adminPanel == null ? void 0 : adminPanel.classList.add("hidden");
        ...
        navDashboard == null ? void 0 : navDashboard.classList.toggle("active", isDashboard);
        navSettings == null ? void 0 : navSettings.classList.toggle("active", isSettings);
        navTeam == null ? void 0 : navTeam.classList.toggle("active", isTeam);
        navDiscord == null ? void 0 : navDiscord.classList.toggle("active", isDiscord);
        navLinked == null ? void 0 : navLinked.classList.toggle("active", isLinked);
        navAdmin == null ? void 0 : navAdmin.classList.toggle("active", isAdmin);
        if (!isSettings) {
      ...
      function createModuleCard({ id, title, icon } = {}) {
        ...
        if (slot && slot.body) {
          ...
          if (headingEl) {
            const baseText = typeof title === "string" && title.length ? title : headingEl.textContent || id || "Module";
            headingEl.textContent = icon ? `${icon} ${baseText}`.trim() : baseText;
          }
          (_a2 = slot.card) == null ? void 0 : _a2.classList.remove("module-hidden");
          return {
            card: slot.card,
            header: slot.header,
            body: slot.body,
            ...
            remove() {
              ...
              (_a3 = slot.card) == null ? void 0 : _a3.classList.add("module-hidden");
            }
          };
        }
      ...
      const errorMessages = {
        ...
        image_too_large: "The server rejected the image as too large. The control panel accepts files up to 40 MB, but your hosting provider may enforce a smaller limit. Try a smaller image or contact your host to raise the cap.",
      ...
      function preparePublicKeyOptions(options) {
        ...
        if ((_a2 = clone.user) == null ? void 0 : _a2.id) clone.user.id = bufferFromBase64Url(clone.user.id);
        const transformDescriptor = (desc) => {
          const next = __spreadValues({}, desc);
      ...
      function credentialToJSON(credential) {
        ...
        return {
          ...
          response: {
            ...
            transports: typeof response.getTransports === "function" ? response.getTransports() : response.transports || void 0,
            publicKeyAlgorithm: response.publicKeyAlgorithm,
            publicKey: response.publicKey ? base64UrlFromBuffer(response.publicKey) : void 0
          },
          clientExtensionResults: credential.getClientExtensionResults ? credential.getClientExtensionResults() : void 0
        };
      }
      ...
      async function changePassword() {
        ...
        hideNotice(passwordStatus);
        const currentValue = (currentPasswordInput == null ? void 0 : currentPasswordInput.value) || "";
        const nextValue = (newPasswordInput == null ? void 0 : newPasswordInput.value) || "";
        const confirmValue = (confirmPasswordInput == null ? void 0 : confirmPasswordInput.value) || "";
        ...
        const restore = btnChangePassword ? { disabled: btnChangePassword.disabled, text: btnChangePassword.textContent } : null;
      ...
      function detectDefaultApiBase() {
        ...
        const hasWindow = typeof window !== "undefined" && (window == null ? void 0 : window.location);
        ...
        const metaContent = (_b2 = (_a2 = document.querySelector('meta[name="panel-api-base"]')) == null ? void 0 : _a2.content) == null ? void 0 : _b2.trim();
        if (metaContent) {
          if (hasWindow) {
            const locationBase = ((_c = window.location) == null ? void 0 : _c.href) || ((_d = window.location) == null ? void 0 : _d.origin);
            if (locationBase) {
              try {
        ...
        if (hasWindow && ((_e = window.location) == null ? void 0 : _e.origin)) {
      ...
      async function resolveApiBase() {
        ...
        const fallback = candidates.find((c) => c.source === "relative") || candidates.find((c) => c.source === "detected") || candidates[0];
        if (fallback == null ? void 0 : fallback.base) {
      ...
      function updateRegisterUi(message) {
        ...
        if (state.allowRegistration) {
          ...
          btnRegister == null ? void 0 : btnRegister.removeAttribute("disabled");
        } else {
          registerForm.classList.add("hidden");
          btnRegister == null ? void 0 : btnRegister.setAttribute("disabled", "disabled");
        }
      ...
      function leaveCurrentServer(reason = "close") {
        ...
        if ((socket == null ? void 0 : socket.connected) && hasServerCapability("console")) {
          try {
            socket.emit("leave-server", previous);
          } catch (err) {
          }
        }
      ...
      function pickNumber(...values) {
        for (const value of values) {
          const num2 = coerceNumber(value);
          if (num2 != null) return num2;
        }
        return null;
      }
      const PLACEHOLDER_STRINGS = /* @__PURE__ */ new Set(["-", "--", "n/a", "na", "none", "null", "undefined"]);
      ...
      function pickServerInfoString(...values) {
        for (const value of values) {
          ...
          const isPlaceholder = PLACEHOLDER_STRINGS.has(normalized) && !(normalized === "na" && bareNa) || collapsed && PLACEHOLDER_STRINGS.has(collapsed) && !bareNa;
      ...
      function formatNumber(value, { fractionDigits } = {}) {
        const num2 = coerceNumber(value);
        if (num2 == null) return "\u2014";
        if (typeof fractionDigits === "number") return num2.toFixed(fractionDigits);
      ...
      const relativeTimeFormatter = typeof Intl !== "undefined" && typeof Intl.RelativeTimeFormat === "function" ? new Intl.RelativeTimeFormat(void 0, { numeric: "auto" }) : null;
      function formatRelativeTime(value) {
        const text2 = pickString(value);
        if (!text2) return "";
        const date = new Date(text2);
        if (Number.isNaN(date.valueOf())) return text2;
      ...
      function updateWorkspaceDisplay(entry) {
        ...
        const numericId = Number((_b2 = (_a2 = entry.data) == null ? void 0 : _a2.id) != null ? _b2 : entry.data);
        ...
        if (workspaceMeta) {
          const tlsLabel = server.tls ? " \xB7 TLS" : "";
          workspaceMeta.textContent = server.host ? `${server.host}:${server.port}${tlsLabel}` : "";
        }
        const status = entry.status;
        const serverInfo = (status == null ? void 0 : status.details) ? parseServerInfo(status.details) : null;
        const pill = workspaceStatus;
        const playersOnline = pickNumber((_d = (_c = status == null ? void 0 : status.details) == null ? void 0 : _c.players) == null ? void 0 : _d.online, serverInfo == null ? void 0 : serverInfo.Players, serverInfo == null ? void 0 : serverInfo.players);
        const maxPlayers = pickNumber((_f = (_e = status == null ? void 0 : status.details) == null ? void 0 : _e.players) == null ? void 0 : _f.max, serverInfo == null ? void 0 : serverInfo.MaxPlayers, serverInfo == null ? void 0 : serverInfo.maxPlayers);
        const queueCount = pickNumber((_g = status == null ? void 0 : status.details) == null ? void 0 : _g.queued, serverInfo == null ? void 0 : serverInfo.Queued, serverInfo == null ? void 0 : serverInfo.queue);
        const joiningCount = pickNumber((_h = status == null ? void 0 : status.details) == null ? void 0 : _h.joining, (_i = status == null ? void 0 : status.details) == null ? void 0 : _i.sleepers, serverInfo == null ? void 0 : serverInfo.Joining, serverInfo == null ? void 0 : serverInfo.joining);
        const framerate = pickNumber(serverInfo == null ? void 0 : serverInfo.Framerate, serverInfo == null ? void 0 : serverInfo.framerate, serverInfo == null ? void 0 : serverInfo.fps);
        const networkIn = pickNumber(serverInfo == null ? void 0 : serverInfo.NetworkIn, serverInfo == null ? void 0 : serverInfo.networkIn, serverInfo == null ? void 0 : serverInfo.network_in);
        const networkOut = pickNumber(serverInfo == null ? void 0 : serverInfo.NetworkOut, serverInfo == null ? void 0 : serverInfo.networkOut, serverInfo == null ? void 0 : serverInfo.network_out);
        const uptimeSeconds = pickNumber(serverInfo == null ? void 0 : serverInfo.Uptime, serverInfo == null ? void 0 : serverInfo.uptime, serverInfo == null ? void 0 : serverInfo.uptimeSeconds, serverInfo == null ? void 0 : serverInfo.UptimeSeconds);
        const gameTime = pickServerInfoString(serverInfo == null ? void 0 : serverInfo.GameTime, serverInfo == null ? void 0 : serverInfo.gameTime, serverInfo == null ? void 0 : serverInfo.game_time);
        const lastSave = pickServerInfoString(serverInfo == null ? void 0 : serverInfo.SaveCreatedTime, serverInfo == null ? void 0 : serverInfo.saveCreatedTime, serverInfo == null ? void 0 : serverInfo.save_created_time);
        const hostname = pickServerInfoString((_j = status == null ? void 0 : status.details) == null ? void 0 : _j.hostname, serverInfo == null ? void 0 : serverInfo.Hostname, serverInfo == null ? void 0 : serverInfo.hostname);
        const online = !!(status == null ? void 0 : status.ok);
        if (pill) {
          let cls = "status-pill";
          if (online) {
          ...
          pill.className = cls;
          pill.title = hostname || (status == null ? void 0 : status.error) || "";
        }
        if (workspacePlayers) {
        ...
        emitWorkspaceEvent("workspace:server-status", {
          ...
          status: {
            ...
            lastCheck: (status == null ? void 0 : status.lastCheck) || null
          }
        });
      }
      function defaultWorkspaceDiscordConfig() {
        return {
          ...
          presenceStatuses: __spreadValues({}, DEFAULT_DISCORD_PRESENCE_STATUSES),
          fields: __spreadValues({}, DEFAULT_DISCORD_STATUS_FIELDS),
          ticketing: __spreadValues({}, DEFAULT_DISCORD_TICKETING_CONFIG)
        };
      }
      ...
      function normalizeWorkspaceTicketing(ticketing = {}) {
        ...
        return {
          ...
          categoryId: normalizeSnowflake((_b2 = (_a2 = source.categoryId) != null ? _a2 : source.category_id) != null ? _b2 : base.categoryId),
          logChannelId: normalizeSnowflake((_d = (_c = source.logChannelId) != null ? _c : source.log_channel_id) != null ? _d : base.logChannelId),
          staffRoleId: normalizeSnowflake((_f = (_e = source.staffRoleId) != null ? _e : source.staff_role_id) != null ? _f : base.staffRoleId),
          pingStaffOnOpen: typeof source.pingStaffOnOpen === "boolean" ? source.pingStaffOnOpen : base.pingStaffOnOpen,
          panelChannelId: normalizeSnowflake((_h = (_g = source.panelChannelId) != null ? _g : source.panel_channel_id) != null ? _h : base.panelChannelId),
          panelMessageId: normalizeSnowflake((_j = (_i = source.panelMessageId) != null ? _i : source.panel_message_id) != null ? _j : base.panelMessageId)
        };
      }
      function normalizeTeamCommandPermissions(commandPermissions = {}) {
        ...
        return {
          status: normalizeCommandRoleList((_b2 = (_a2 = source.status) != null ? _a2 : source.ruststatus) != null ? _b2 : base.status),
          ticket: normalizeCommandRoleList((_c = source.ticket) != null ? _c : base.ticket),
          rustlookup: normalizeCommandRoleList((_e = (_d = source.rustlookup) != null ? _d : source.lookup) != null ? _e : base.rustlookup),
          auth: normalizeCommandRoleList((_f = source.auth) != null ? _f : base.auth)
        };
      }
      function normalizeUrlConfig(value, max = 800) {
        ...
        const limit = Number.isFinite(max) && max > 0 ? max : void 0;
        return limit ? text2.slice(0, limit) : text2;
      }
      ...
      function normalizeTeamOAuthConfig(oauth = {}) {
        ...
        return {
          discord: {
            clientId: normalizeDiscordClientId((_a2 = discord.clientId) != null ? _a2 : discord.client_id),
            clientSecret: normalizeSecretValue((_b2 = discord.clientSecret) != null ? _b2 : discord.client_secret, 400),
            redirectUri: normalizeUrlConfig((_c = discord.redirectUri) != null ? _c : discord.redirect_uri, 800)
          },
          steam: {
            apiKey: normalizeSecretValue((_e = (_d = steam.apiKey) != null ? _d : steam.api_key) != null ? _e : steam.webApiKey, 120),
            realm: normalizeUrlConfig((_f = steam.realm) != null ? _f : steam.realm_url, 800),
            returnUrl: normalizeUrlConfig((_h = (_g = steam.returnUrl) != null ? _g : steam.return_url) != null ? _h : steam.callbackUrl, 800)
          }
        };
      }
      ...
      function normalizeWorkspaceDiscordStatus(status) {
        ...
        const playersCurrent = Number((_a2 = status.players) == null ? void 0 : _a2.current);
        const playersMax = Number((_b2 = status.players) == null ? void 0 : _b2.max);
        const joiningRaw = Number(status.joining);
        const presenceRaw = (_c = pickString(status.presence)) == null ? void 0 : _c.toLowerCase();
        const presence = DISCORD_ALLOWED_PRESENCES.has(presenceRaw) ? presenceRaw : status.serverOnline ? "online" : "dnd";
        ...
        return {
          serverOnline: Boolean((_d = status.serverOnline) != null ? _d : presence === "online"),
          players: {
      ...
      function updateWorkspaceDiscordConfigUi(config = state.workspaceDiscord.config) {
        ...
        discordStatusFieldInputs.forEach((input) => {
          var _a2;
          if (!input) return;
          const key = (_a2 = input.dataset) == null ? void 0 : _a2.statusField;
          if (!key) return;
      ...
      function updateWorkspaceDiscordEnabledFields(fields = {}) {
        ...
        const active = Object.entries(fields).filter(([, value]) => Boolean(value)).map(([key]) => key);
        if (!active.length) {
      ...
      function updateWorkspaceDiscordConnectionUi(integration = state.workspaceDiscord.integration) {
        const guildId = (integration == null ? void 0 : integration.guildId) || "";
        const channelId = (integration == null ? void 0 : integration.channelId) || "";
        const hasToken = Boolean(integration == null ? void 0 : integration.hasToken);
        ...
        if (discordConnectionTokenInput && !discordConnectionTokenInput.value) {
          discordConnectionTokenInput.placeholder = hasToken ? "Leave blank to keep the saved token" : "Paste the Discord bot token";
        }
      ...
      function updateWorkspaceDiscordStatusUi(status = state.workspaceDiscord.status) {
        ...
        if (discordCurrentPlayers) {
          const value = Number.isFinite((_a2 = details.players) == null ? void 0 : _a2.current) ? details.players.current : 0;
          discordCurrentPlayers.textContent = value.toLocaleString();
        }
        if (discordMaxPlayers) {
          const max = Number.isFinite((_b2 = details.players) == null ? void 0 : _b2.max) ? details.players.max : null;
      ...
      async function loadWorkspaceDiscord(serverId, { force = false } = {}) {
        ...
        try {
          ...
          const integration = (data == null ? void 0 : data.integration) || null;
          const status = (data == null ? void 0 : data.status) || null;
          state.workspaceDiscord.integration = integration;
          setWorkspaceDiscordConfig((integration == null ? void 0 : integration.config) || null);
      ...
      function gatherWorkspaceDiscordPayload() {
        const template = normalizeWorkspacePresenceTemplate(discordPresenceTemplateInput == null ? void 0 : discordPresenceTemplateInput.value);
        const statuses = {
          online: sanitizePresenceValue(discordPresenceOnlineSelect == null ? void 0 : discordPresenceOnlineSelect.value, "online"),
          offline: sanitizePresenceValue(discordPresenceOfflineSelect == null ? void 0 : discordPresenceOfflineSelect.value, "offline"),
          stale: sanitizePresenceValue(discordPresenceStaleSelect == null ? void 0 : discordPresenceStaleSelect.value, "stale"),
          waiting: sanitizePresenceValue(discordPresenceWaitingSelect == null ? void 0 : discordPresenceWaitingSelect.value, "waiting")
        };
        const fields = __spreadValues({}, DEFAULT_DISCORD_STATUS_FIELDS);
        discordStatusFieldInputs.forEach((input) => {
          var _a2;
          if (!input) return;
          const key = (_a2 = input.dataset) == null ? void 0 : _a2.statusField;
        ...
        const guildId = toOptionalId(discordConnectionGuildInput == null ? void 0 : discordConnectionGuildInput.value);
        const channelId = toOptionalId(discordConnectionChannelInput == null ? void 0 : discordConnectionChannelInput.value);
        const botToken = typeof (discordConnectionTokenInput == null ? void 0 : discordConnectionTokenInput.value) === "string" ? discordConnectionTokenInput.value.trim() : "";
      ...
      async function handleDiscordStatusSubmit(ev) {
        ...
        try {
          ...
          const integration = (data == null ? void 0 : data.integration) || null;
          state.workspaceDiscord.integration = integration;
          setWorkspaceDiscordConfig((integration == null ? void 0 : integration.config) || payload.config);
          setWorkspaceDiscordStatus((data == null ? void 0 : data.status) || state.workspaceDiscord.status);
          state.workspaceDiscord.error = null;
      ...
      function showWorkspaceForServer(id) {
        ...
        dashboardPanel == null ? void 0 : dashboardPanel.classList.add("hidden");
        settingsPanel == null ? void 0 : settingsPanel.classList.add("hidden");
        workspacePanel == null ? void 0 : workspacePanel.classList.remove("hidden");
        setWorkspaceView(workspaceViewDefault);
      ...
      function ensureSocket() {
        ...
        socket = io(socketBase || void 0, {
          transports: ["websocket"],
          auth: { token: state.TOKEN || void 0 }
        });
        socket.on("connect", () => {
        ...
        socket.on("console", (msg) => {
          var _a2, _b2;
          const raw = typeof msg === "string" ? msg : (_b2 = (_a2 = msg == null ? void 0 : msg.Message) != null ? _a2 : msg == null ? void 0 : msg.message) != null ? _b2 : "";
        ...
        socket.on("error", (err) => {
          const message = typeof err === "string" ? err : (err == null ? void 0 : err.message) || JSON.stringify(err);
          ui.log("Socket error: " + message);
        });
        socket.on("connect_error", (err) => {
          const message = (err == null ? void 0 : err.message) || "connection error";
      ...
      function updateServerStatus(id, status) {
        ...
        const serverInfo = (status == null ? void 0 : status.details) ? parseServerInfo(status.details) : null;
        const queued = pickNumber((_a2 = status == null ? void 0 : status.details) == null ? void 0 : _a2.queued, serverInfo == null ? void 0 : serverInfo.Queued, serverInfo == null ? void 0 : serverInfo.queue);
        const players = pickNumber((_c = (_b2 = status == null ? void 0 : status.details) == null ? void 0 : _b2.players) == null ? void 0 : _c.online, serverInfo == null ? void 0 : serverInfo.Players, serverInfo == null ? void 0 : serverInfo.players);
        const maxPlayers = pickNumber((_e = (_d = status == null ? void 0 : status.details) == null ? void 0 : _d.players) == null ? void 0 : _e.max, serverInfo == null ? void 0 : serverInfo.MaxPlayers, serverInfo == null ? void 0 : serverInfo.maxPlayers);
        const joining = pickNumber((_f = status == null ? void 0 : status.details) == null ? void 0 : _f.joining, (_g = status == null ? void 0 : status.details) == null ? void 0 : _g.sleepers, serverInfo == null ? void 0 : serverInfo.Joining, serverInfo == null ? void 0 : serverInfo.joining);
        const hostname = pickServerInfoString((_h = status == null ? void 0 : status.details) == null ? void 0 : _h.hostname, serverInfo == null ? void 0 : serverInfo.Hostname, serverInfo == null ? void 0 : serverInfo.hostname);
        ...
        if (details) {
          ...
          details.title = ((_i = status == null ? void 0 : status.details) == null ? void 0 : _i.raw) || (status == null ? void 0 : status.error) || "";
        }
        updateWorkspaceDisplay(entry);
      ...
      function renderServer(server, status) {
        const entry = { data: __spreadValues({}, server), status: null };
        const card = document.createElement("div");
        ...
        const playersStat = createServerStat("\u{1F465}", "Players");
        const queueStat = createServerStat("\u23F3", "Queue");
        const joiningStat = createServerStat("\u{1F6AA}", "Joining");
        ...
        if (canManageServer) {
          ...
          removeBtn.addEventListener("click", async (ev) => {
            var _a2;
            ev.preventDefault();
            const label = ((_a2 = entry.data) == null ? void 0 : _a2.name) || server.name || `Server #${server.id}`;
            const confirmed = await confirmDialog({
              title: "Remove server",
          ...
          editForm.addEventListener("submit", async (ev) => {
            ...
            try {
              ...
              entry.data = __spreadProps(__spreadValues({}, entry.data), { name, host, port, tls: useTls ? 1 : 0 });
              nameEl.textContent = name;
              metaEl.textContent = `${host}:${port}${useTls ? " \xB7 TLS" : ""}`;
      ...
      async function refreshServers() {
        ...
        try {
          ...
          for (const server of list) {
            const status = (statuses == null ? void 0 : statuses[server.id]) || (statuses == null ? void 0 : statuses[String(server.id)]);
            renderServer(server, status);
          }
          const hasServers = list.length > 0;
          serversEmpty == null ? void 0 : serversEmpty.classList.toggle("hidden", hasServers);
          if (!hasServers) {
            showAddServerCard();
      ...
      function connectServer(id) {
        ...
        const name = ((_a2 = entry == null ? void 0 : entry.data) == null ? void 0 : _a2.name) || `Server #${numericId}`;
        ...
        showWorkspaceForServer(numericId);
        moduleBus.emit("server:connected", { serverId: numericId, server: (entry == null ? void 0 : entry.data) || null });
      ...
      const ui = {
        showLogin() {
          ...
          mainNav == null ? void 0 : mainNav.classList.add("hidden");
          workspacePanel == null ? void 0 : workspacePanel.classList.add("hidden");
          switchPanel("dashboard");
        },
        showApp() {
          ...
          mainNav == null ? void 0 : mainNav.classList.remove("hidden");
          workspacePanel == null ? void 0 : workspacePanel.classList.add("hidden");
          dashboardPanel == null ? void 0 : dashboardPanel.classList.remove("hidden");
          settingsPanel == null ? void 0 : settingsPanel.classList.add("hidden");
...
`;
        ...
        setUser(user) {
          if (navSettings) {
            const label = (user == null ? void 0 : user.username) || "Account";
            navSettings.textContent = label;
            navSettings.title = "Open account settings";
          }
          if (welcomeName) welcomeName.textContent = (user == null ? void 0 : user.username) || "operator";
          if (profileMenuTrigger) {
            profileMenuTrigger.disabled = !user;
            profileMenuTrigger.setAttribute("aria-expanded", "false");
            const triggerLabel = (user == null ? void 0 : user.username) ? `Open profile menu for ${user.username}` : "Open profile menu";
            profileMenuTrigger.setAttribute("aria-label", triggerLabel);
          }
          closeProfileMenu();
          userBox.innerHTML = "";
          if (profileUsername) profileUsername.textContent = (user == null ? void 0 : user.username) || "\u2014";
          if (profileRole) {
      ...
      function getServerData(id) {
        var _a2;
        return ((_a2 = state.serverItems.get(String(id))) == null ? void 0 : _a2.data) || null;
      }
      ...
      async function authorizedFetch(path, options = {}) {
        ...
        const _a2 = options || {}, { absolute = false, headers: inputHeaders } = _a2, rest = __objRest(_a2, ["absolute", "headers"]);
        const headers = new Headers(inputHeaders || {});
        headers.set("Authorization", "Bearer " + state.TOKEN);
        const fetchOptions = __spreadProps(__spreadValues({}, rest), { headers });
      ...
      const moduleHostContext = {
        ...
        getSettings: () => __spreadValues({}, state.settings),
        openSettings: () => switchPanel("settings")
      };
      if ((_b = window.ModuleLoader) == null ? void 0 : _b.init) {
      ...
      async function api(path, body = null, method = "GET") {
        ...
        if (!res.ok) {
          ...
          const code = (data == null ? void 0 : data.error) || fallbackCode;
          const err = new Error(code);
          err.status = res.status;
          if (data == null ? void 0 : data.error) err.code = data.error;
      ...
      async function publicJson(path, { method = "GET", body = null } = {}) {
        ...
        if (contentType.includes("application/json")) data = await res.json();
        if (!res.ok) {
          const err = new Error((data == null ? void 0 : data.error) || "api_error");
          err.status = res.status;
          err.body = data;
          throw err;
        }
      ...
      async function loadUsers() {
        ...
        try {
          ...
          if (activeUserDetails) {
            if (activeMatch) {
              activeUserDetails = __spreadValues({}, activeMatch);
              renderUserDetails(activeUserDetails);
            } else {
              closeUserDetails();
            }
      ...
      function populateAdminTeamSelect(select2, { allowEmpty = false, placeholder = "" } = {}) {
        if (!select2) return;
        const teams = state.admin.teams || [];
        const previous = select2.value;
        select2.innerHTML = "";
        if (allowEmpty) {
          const option = document.createElement("option");
          option.value = "";
        ...
        select2.disabled = !teams.length && !allowEmpty;
        if (previous && Array.from(select2.options).some((opt) => opt.value === previous)) {
      ...
      function renderAdminTeams() {
        ...
        teams.forEach((team) => {
          ...
          members.textContent = `${Number((_a2 = team.member_count) != null ? _a2 : 0)} member(s)`;
      ...
      function renderAdminUsers() {
        ...
        const filtered = filter ? users.filter((user) => {
          const username = (user.username || "").toLowerCase();
          const roleLabel = (formatUserRole(user) || "").toString().toLowerCase();
          const teamMatch = Array.isArray(user.teams) ? user.teams.some((team) => (team.name || `team #${team.id}`).toLowerCase().includes(filter)) : false;
        ...
        filtered.forEach((user) => {
          ...
          const trailing = document.createElement("div");
          trailing.className = "user-item-trailing";
          if (user.id === ((_a2 = state.currentUser) == null ? void 0 : _a2.id)) {
            const badge = document.createElement("span");
            badge.className = "badge";
            badge.textContent = "You";
            trailing.appendChild(badge);
      ...
      async function loadAdminOverview({ preserveSelection = true, selectUserId = null } = {}) {
        ...
        try {
          ...
          const desiredId = selectUserId != null ? selectUserId : preserveSelection ? state.admin.selectedUserId : null;
          if (desiredId && state.admin.users.some((entry) => entry.id === desiredId)) {
            state.admin.selectedUserId = desiredId;
          } else {
            state.admin.selectedUserId = (_b2 = (_a2 = state.admin.users[0]) == null ? void 0 : _a2.id) != null ? _b2 : null;
          }
          renderAdminUsers();
      ...
      async function handleAdminCreateUser() {
        ...
        if (!hasGlobalPermission("manageUsers")) return;
        hideNotice(adminUserFeedback);
        const username = (_a2 = adminNewUserName == null ? void 0 : adminNewUserName.value) == null ? void 0 : _a2.trim();
        const password = (adminNewUserPassword == null ? void 0 : adminNewUserPassword.value) || "";
        const role = (adminNewUserRole == null ? void 0 : adminNewUserRole.value) || "";
        const teamIdRaw = (adminNewUserTeam == null ? void 0 : adminNewUserTeam.value) || "";
        const superuser = (adminNewUserSuperuser == null ? void 0 : adminNewUserSuperuser.checked) || false;
        ...
        try {
          ...
          await loadAdminOverview({ preserveSelection: false, selectUserId: created == null ? void 0 : created.id });
        } catch (err) {
          if (errorCode(err) === "unauthorized") handleUnauthorized();
          else showNotice(adminUserFeedback, describeError(err), "error");
        }
      ...
      async function handleAdminRoleSave() {
        ...
        const desiredSuperuser = (_a2 = adminUserSuperuser == null ? void 0 : adminUserSuperuser.checked) != null ? _a2 : user.superuser;
      ...
      async function handleAdminAssignTeam() {
        ...
        const role = (adminAssignRole == null ? void 0 : adminAssignRole.value) || "user";
        if (!teamId) {
      ...
      function formatPermissionLabel(value) {
        if (!value) return "";
        return String(value).replace(/([A-Z])/g, " $1").replace(/[-_]/g, " ").replace(/^\s+|\s+$/g, "").replace(/^./, (c) => c.toUpperCase());
      }
      ...
      function handleRoleServersChange(event) {
        ...
        if (value === "*") {
          if (target.checked) {
            roleServersPreviousSelection = roleServersSelection.includes("*") ? [] : roleServersSelection.filter((entry) => entry !== "*");
          ...
          roleServersPreviousSelection = [...roleServersSelection];
          const allOption = roleServersList == null ? void 0 : roleServersList.querySelector('input[type="checkbox"][data-role-server="*"]');
      ...
      function renderRoleEditorFields() {
        ...
        if (roleCapabilitiesContainer) {
          ...
          const caps = ((_a2 = state.roleTemplates) == null ? void 0 : _a2.serverCapabilities) || [];
          if (!caps.length) {
        ...
        if (roleGlobalContainer) {
          ...
          const perms = ((_b2 = state.roleTemplates) == null ? void 0 : _b2.globalPermissions) || [];
          if (!perms.length) {
            const note = document.createElement("p");
            note.className = "muted small role-checkbox-empty";
      ...
      function getDefaultRoleKey(roles2 = state.roles) {
        var _a2;
        const list = Array.isArray(roles2) ? roles2 : [];
        if (!list.length) return "";
        const preferred = list.find((role) => (role == null ? void 0 : role.key) === "user");
        if (preferred == null ? void 0 : preferred.key) return preferred.key;
        return ((_a2 = list[0]) == null ? void 0 : _a2.key) || "";
      }
      function applyDefaultRoleSelection(select2, roles2 = state.roles) {
        if (!select2) return;
        const defaultKey = getDefaultRoleKey(roles2);
        const options = Array.from(select2.options || []).map((opt) => opt.value);
        if (defaultKey && options.includes(defaultKey)) {
          select2.value = defaultKey;
        } else if (options.length) {
          select2.value = options[0];
        } else {
          select2.value = "";
        }
      }
      function populateRoleSelectOptions(select2, roles2 = [], preserve = true) {
        if (!select2) return;
        const previous = preserve ? select2.value : "";
        select2.innerHTML = "";
        roles2.forEach((role) => {
          const option = document.createElement("option");
        ...
        if (previous && roles2.some((role) => role.key === previous)) {
          select2.value = previous;
        } else {
          applyDefaultRoleSelection(select2, roles2);
        }
      }
      function updateRoleOptions() {
        const roles2 = state.roles || [];
        populateRoleSelectOptions(newUserRole, roles2);
        populateRoleSelectOptions(existingUserRole, roles2);
        populateRoleSelectOptions(userDetailsRoleSelect, roles2);
        populateRoleSelectOptions(adminNewUserRole, roles2);
        populateRoleSelectOptions(adminAssignRole, roles2);
        populateRoleSelectOptions(adminUserRoleSelect, roles2);
        populateRoleSelectOptions(roleSelect, roles2, false);
      }
      function applyRoleToEditor(role) {
        ...
        setRoleServersSelection((_b2 = (_a2 = role.permissions) == null ? void 0 : _a2.servers) == null ? void 0 : _b2.allowed);
        renderRoleServersOptions();
        if (roleCapabilitiesContainer) {
          const caps = ((_d = (_c = role.permissions) == null ? void 0 : _c.servers) == null ? void 0 : _d.capabilities) || {};
          roleCapabilitiesContainer.querySelectorAll("input[data-role-capability]").forEach((input) => {
            ...
            input.checked = !!(caps == null ? void 0 : caps[cap]);
          });
        }
        if (roleGlobalContainer) {
          const globals = ((_e = role.permissions) == null ? void 0 : _e.global) || {};
          roleGlobalContainer.querySelectorAll("input[data-role-global]").forEach((input) => {
            const perm = input.dataset.roleGlobal;
            input.checked = !!(globals == null ? void 0 : globals[perm]);
          });
        }
        const currentRoleKey = (((_f = state.currentUser) == null ? void 0 : _f.role) || "").toLowerCase();
      ...
      function setRoleEditorLocked(locked) {
        ...
        const allowAll = roleServersSelection.includes("*");
        roleServersList == null ? void 0 : roleServersList.querySelectorAll('input[type="checkbox"]').forEach((input) => {
          const isAllToggle = input.dataset.roleServer === "*";
          input.disabled = roleEditorLocked || !isAllToggle && allowAll;
        });
        roleCapabilitiesContainer == null ? void 0 : roleCapabilitiesContainer.querySelectorAll('input[type="checkbox"]').forEach((input) => {
          input.disabled = roleEditorLocked;
        });
        roleGlobalContainer == null ? void 0 : roleGlobalContainer.querySelectorAll('input[type="checkbox"]').forEach((input) => {
          input.disabled = roleEditorLocked;
        });
      }
      async function handleRoleCreate() {
        ...
        hideNotice(roleFeedback);
        const keyValue = ((newRoleKey == null ? void 0 : newRoleKey.value) || "").trim().toLowerCase();
        const nameValue = (_a2 = newRoleName == null ? void 0 : newRoleName.value) == null ? void 0 : _a2.trim();
      ...
      async function handleRoleSave() {
        ...
        const nameValue = (_a2 = roleNameInput == null ? void 0 : roleNameInput.value) == null ? void 0 : _a2.trim();
        if (!nameValue) {
        ...
        const payload = {
          name: nameValue,
          description: ((_b2 = roleDescriptionInput == null ? void 0 : roleDescriptionInput.value) == null ? void 0 : _b2.trim()) || null,
      ...
      async function loadRoles() {
        ...
        try {
          ...
          state.roles = Array.isArray(data == null ? void 0 : data.roles) ? data.roles : [];
          state.roleTemplates = (data == null ? void 0 : data.templates) || { serverCapabilities: [], globalPermissions: [] };
          ...
          if (!state.roles.length) {
            ...
            const target = activeRoleEditKey && state.roles.some((role) => role.key === activeRoleEditKey) ? activeRoleEditKey : (_a2 = state.roles[0]) == null ? void 0 : _a2.key;
      ...
      function canManageTeamDiscord() {
        return hasGlobalPermission("manageUsers") || hasGlobalPermission("manageRoles") || hasGlobalPermission("manageServers");
      }
      ...
      async function handleTeamAuthSubmit(ev) {
        ...
        const enabled = !!(teamAuthEnabledInput == null ? void 0 : teamAuthEnabledInput.checked);
        const roleValue = normalizeTeamAuthRoleId(teamAuthRoleInput == null ? void 0 : teamAuthRoleInput.value);
        const logChannelValue = normalizeTeamAuthLogChannelId(teamAuthLogChannelInput == null ? void 0 : teamAuthLogChannelInput.value);
        const payload = {
          enabled,
        ...
        try {
          ...
          state.teamAuth.enabled = !!((_a2 = data == null ? void 0 : data.enabled) != null ? _a2 : payload.enabled);
          state.teamAuth.roleId = (data == null ? void 0 : data.roleId) != null && data.roleId !== "" ? String(data.roleId) : payload.roleId || null;
          state.teamAuth.logChannelId = (data == null ? void 0 : data.logChannelId) != null && data.logChannelId !== "" ? String(data.logChannelId) : payload.logChannelId || null;
          state.teamAuth.loaded = true;
          state.teamAuth.loadedTeamId = (_b2 = state.activeTeamId) != null ? _b2 : null;
      ...
      function resetTeamOAuthInputs() {
        [teamDiscordOauthClientId, teamDiscordOauthRedirectUri, teamDiscordOauthClientSecret, teamSteamApiKeyInput].forEach((input) => {
          if (!input) return;
      ...
      function selectedRolesFromSelect(select2) {
        if (!select2) return [];
        return Array.from(select2.selectedOptions || []).map((option) => option.value).filter(Boolean);
        function getCommandPermissionsDraft() {
          var _a2;
          const config = ((_a2 = state.teamDiscord) == null ? void 0 : _a2.config) || defaultTeamDiscordConfig();
          return normalizeTeamCommandPermissions(config.commandPermissions || {});
        }
        function syncCommandRoleOptions(select3, roles2, disabled = false) {
          if (!select3) return;
          const roleList = Array.isArray(roles2) ? roles2 : [];
          const fragment = document.createDocumentFragment();
          ...
          select3.value = "";
          select3.disabled = disabled || !roleList.length;
        }
        function renderCommandRoleList(list, values, roleLookup, commandKey, disabled = false) {
          ...
          ids.forEach((id) => {
            ...
            const name = ((_a2 = roleLookup == null ? void 0 : roleLookup.get(id)) == null ? void 0 : _a2.name) || id;
            const label = document.createElement("span");
        ...
        function removeCommandRole2(commandKey, roleValue) {
          if (!commandKey) return;
          const draft = getCommandPermissionsDraft();
          const next = new Set(draft[commandKey] || []);
        ...
        function handleCommandRoleSelect2(commandKey, value) {
        ...
        function commitCommandRoleInput2(commandKey) {
          const input = {
            status: teamCommandStatusInput,
            ticket: teamCommandTicketInput,
            rustlookup: teamCommandLookupInput,
          ...
          const ids = raw.split(/[,\s]+/g).map((value) => normalizeCommandRoleValue(value)).filter(Boolean);
          input.value = "";
        ...
        function syncDiscordRoleOptions(list, roles2) {
          if (!list) return;
          const fragment = document.createDocumentFragment();
          (Array.isArray(roles2) ? roles2 : []).forEach((role) => {
            const option = document.createElement("option");
            option.value = role.id;
        ...
        function syncIdSelectOptions(select3, items, currentValue, placeholder) {
          if (!select3) return;
          const fragment = document.createDocumentFragment();
          ...
          (Array.isArray(items) ? items : []).forEach((item) => {
            const option = document.createElement("option");
            option.value = (item == null ? void 0 : item.id) || "";
            option.textContent = (item == null ? void 0 : item.name) ? `${item.name}` : (item == null ? void 0 : item.id) || "Unknown";
            fragment.append(option);
          });
          select3.innerHTML = "";
          select3.append(fragment);
          if (currentValue && select3.querySelector(`option[value="${currentValue}"]`)) {
            select3.value = currentValue;
          } else {
            select3.value = "";
          }
        }
        function updateTeamDiscordConfigUi2(config = ((_a2) => (_a2 = state.teamDiscord) == null ? void 0 : _a2.config)()) {
          ...
          const hasSettings = Boolean(stateObj == null ? void 0 : stateObj.hasToken) || Boolean(stateObj == null ? void 0 : stateObj.guildId);
          ...
          const availableCategories = Array.isArray((_a3 = state.teamDiscordChannels) == null ? void 0 : _a3.categories) ? state.teamDiscordChannels.categories : [];
          const availableChannels = Array.isArray((_b2 = state.teamDiscordChannels) == null ? void 0 : _b2.channels) ? state.teamDiscordChannels.channels : [];
          const availableRoles = Array.isArray((_c = state.teamDiscordRoles) == null ? void 0 : _c.roles) ? state.teamDiscordRoles.roles : [];
          const roleLookup = new Map(availableRoles.map((role) => [String(role.id), role]));
          const rolesLoading = Boolean((_d = state.teamDiscordRoles) == null ? void 0 : _d.loading);
          const roleErrorMessage = ((_e = state.teamDiscordRoles) == null ? void 0 : _e.error) || "";
          ...
          const channelsLoading = Boolean((_f = state.teamDiscordChannels) == null ? void 0 : _f.loading);
          const channelsLoadedForTeam = ((_g = state.teamDiscordChannels) == null ? void 0 : _g.loadedTeamId) === state.activeTeamId;
          const channelErrorMessage = ((_h = state.teamDiscordChannels) == null ? void 0 : _h.error) || "";
          ...
          const authRoleValue = normalizeTeamAuthRoleId((_i = state.teamAuth) == null ? void 0 : _i.roleId);
          const authLogChannel = normalizeTeamAuthLogChannelId((_j = state.teamAuth) == null ? void 0 : _j.logChannelId);
          ...
          ticketingInputs2.forEach((input) => {
            if (!input) return;
            input.disabled = !canManage || loading || !hasSettings || !ticketingEnabled || channelsLoading;
          });
          ticketingSelects.forEach((select3) => {
            if (!select3) return;
            select3.disabled = !canManage || loading || !hasSettings || !ticketingEnabled || channelsLoading;
          });
          ...
          const formatTicketValue = (value, lookup) => {
            const text2 = typeof value === "string" ? value.trim() : "";
            if (!text2) return "Not set";
            if (lookup == null ? void 0 : lookup.has(text2)) {
              const item = lookup.get(text2);
              if (item == null ? void 0 : item.name) return item.name;
            }
            return text2;
          };
          ...
          if (teamDiscordOauthClientId && !teamDiscordOauthClientId.matches(":focus")) {
            ...
            (_k = teamDiscordOauthClientId.dataset) == null ? true : delete _k.touched;
          }
          if (teamDiscordOauthRedirectUri && !teamDiscordOauthRedirectUri.matches(":focus")) {
            ...
            (_l = teamDiscordOauthRedirectUri.dataset) == null ? true : delete _l.touched;
          }
          if (teamDiscordOauthClientSecret && !teamDiscordOauthClientSecret.matches(":focus")) {
            teamDiscordOauthClientSecret.value = "";
            (_m = teamDiscordOauthClientSecret.dataset) == null ? true : delete _m.touched;
          }
          if (teamSteamApiKeyInput && !teamSteamApiKeyInput.matches(":focus")) {
            if (((_n = teamSteamApiKeyInput.dataset) == null ? void 0 : _n.touched) === "true") {
            } else {
              teamSteamApiKeyInput.value = "";
            }
            (_o = teamSteamApiKeyInput.dataset) == null ? true : delete _o.touched;
          }
          ...
          if (teamDiscordOauthClientId) {
            ...
            if (!teamDiscordOauthClientId.matches(":focus")) {
              teamDiscordOauthClientId.placeholder = discordOauth.clientId ? "Client ID stored \u2014 enter to replace" : "Enter Discord OAuth client ID";
            }
          }
          if (teamDiscordOauthClientSecret) {
            teamDiscordOauthClientSecret.disabled = !canManage || loading;
            teamDiscordOauthClientSecret.placeholder = discordOauth.clientSecret ? "Secret stored \u2014 enter to replace" : "Paste Discord OAuth client secret";
          }
          if (teamDiscordOauthRedirectUri) {
            ...
            if (!teamDiscordOauthRedirectUri.matches(":focus")) {
              teamDiscordOauthRedirectUri.placeholder = discordOauth.redirectUri ? "Redirect stored \u2014 enter to replace" : "Optional: custom Discord redirect URI";
            }
          }
          if (teamSteamApiKeyInput) {
            teamSteamApiKeyInput.disabled = !canManage || loading;
            if (!teamSteamApiKeyInput.matches(":focus")) {
              teamSteamApiKeyInput.placeholder = steamOauth.apiKey ? "Key stored \u2014 enter to replace or clear" : "Optional: Steam Web API key";
            }
          }
          ...
          Object.entries(commandInputMap).forEach(([, input]) => {
            ...
            if (!input.matches(":focus")) {
              input.placeholder = commandInputsDisabled ? "Connect the Main Bot to add roles" : "Add role IDs, separated by commas";
            }
          });
          ...
          const formatCommandValue = (value) => {
            ...
            const names = ids.map((id) => {
              var _a4;
              return ((_a4 = roleLookup.get(id)) == null ? void 0 : _a4.name) || id;
            });
            return names.join(", ");
          };
        ...
        async function loadTeamDiscordRoles2({ force = false, showStatus = false } = {}) {
          var _a2, _b2, _c;
          if (!canManageTeamDiscord()) return;
          const activeTeamId = (_a2 = state.activeTeamId) != null ? _a2 : null;
          const hasSettings = Boolean((_b2 = state.teamDiscord) == null ? void 0 : _b2.hasToken) || Boolean((_c = state.teamDiscord) == null ? void 0 : _c.guildId);
          if (!hasSettings) {
            state.teamDiscordRoles = defaultTeamDiscordRolesState();
            updateTeamDiscordConfigUi2();
            return;
          }
          ...
          try {
            ...
            const roles2 = Array.isArray(data == null ? void 0 : data.roles) ? data.roles.map((role) => ({
              id: (role == null ? void 0 : role.id) != null ? String(role.id) : "",
              name: typeof (role == null ? void 0 : role.name) === "string" && role.name.trim() ? role.name.trim() : (role == null ? void 0 : role.id) ? String(role.id) : "Unknown",
              position: Number.isFinite(role == null ? void 0 : role.position) ? Number(role.position) : 0
            })).filter((role) => role.id) : [];
            state.teamDiscordRoles.roles = roles2;
        ...
        async function loadTeamDiscordChannels({ force = false, showStatus = false } = {}) {
          ...
          try {
            ...
            const categories = Array.isArray(data == null ? void 0 : data.categories) ? data.categories.map((category) => ({
              id: (category == null ? void 0 : category.id) != null ? String(category.id) : "",
              name: typeof (category == null ? void 0 : category.name) === "string" && category.name.trim() ? category.name.trim() : (category == null ? void 0 : category.id) ? String(category.id) : "Unknown",
              position: Number.isFinite(category == null ? void 0 : category.position) ? Number(category.position) : 0
            })).filter((category) => category.id) : [];
            const channels = Array.isArray(data == null ? void 0 : data.channels) ? data.channels.map((channel) => ({
              id: (channel == null ? void 0 : channel.id) != null ? String(channel.id) : "",
              name: typeof (channel == null ? void 0 : channel.name) === "string" && channel.name.trim() ? channel.name.trim() : (channel == null ? void 0 : channel.id) ? String(channel.id) : "Unknown",
              position: Number.isFinite(channel == null ? void 0 : channel.position) ? Number(channel.position) : 0
        ...
        function updateTeamTicketingState2() {
          var _a2;
          const current = ((_a2 = state.teamDiscord) == null ? void 0 : _a2.config) || defaultTeamDiscordConfig();
          const ticketing = __spreadValues({}, current.ticketing || DEFAULT_DISCORD_TICKETING_CONFIG);
          ticketing.enabled = Boolean(discordTicketingEnabledInput == null ? void 0 : discordTicketingEnabledInput.checked);
          ticketing.categoryId = ((discordTicketingCategoryInput == null ? void 0 : discordTicketingCategoryInput.value) || "").trim();
          ticketing.logChannelId = ((discordTicketingLogInput == null ? void 0 : discordTicketingLogInput.value) || "").trim();
          ticketing.staffRoleId = ((discordTicketingRoleInput == null ? void 0 : discordTicketingRoleInput.value) || "").trim();
          ticketing.pingStaffOnOpen = Boolean(discordTicketingPingInput == null ? void 0 : discordTicketingPingInput.checked);
          ticketing.panelChannelId = ((discordTicketingPanelChannelInput == null ? void 0 : discordTicketingPanelChannelInput.value) || "").trim();
          ticketing.panelMessageId = ((discordTicketingPanelMessageInput == null ? void 0 : discordTicketingPanelMessageInput.value) || "").trim();
          const updated = normalizeTeamDiscordConfig(__spreadProps(__spreadValues({}, current), { ticketing }));
          state.teamDiscord.config = updated;
          hideNotice(teamTicketingStatus);
          updateTeamDiscordConfigUi2(updated);
        }
        function updateTeamCommandPermissionsState(nextPermissions) {
          ...
          const updated = normalizeTeamDiscordConfig(__spreadProps(__spreadValues({}, current), { commandPermissions }));
          state.teamDiscord.config = updated;
          hideNotice(teamTicketingStatus);
          updateTeamDiscordConfigUi2(updated);
        }
        function updateTeamOAuthState({ clearSecrets = false } = {}) {
          ...
          const clientIdTouched = ((_b2 = teamDiscordOauthClientId == null ? void 0 : teamDiscordOauthClientId.dataset) == null ? void 0 : _b2.touched) === "true";
          const redirectTouched = ((_c = teamDiscordOauthRedirectUri == null ? void 0 : teamDiscordOauthRedirectUri.dataset) == null ? void 0 : _c.touched) === "true";
          const secretTouched = ((_d = teamDiscordOauthClientSecret == null ? void 0 : teamDiscordOauthClientSecret.dataset) == null ? void 0 : _d.touched) === "true";
          const steamKeyTouched = ((_e = teamSteamApiKeyInput == null ? void 0 : teamSteamApiKeyInput.dataset) == null ? void 0 : _e.touched) === "true";
          const oauth = normalizeTeamOAuthConfig({
            discord: {
              clientId: clientIdTouched ? teamDiscordOauthClientId == null ? void 0 : teamDiscordOauthClientId.value : baseOauth.discord.clientId,
              clientSecret: clearSecrets ? null : secretTouched ? teamDiscordOauthClientSecret == null ? void 0 : teamDiscordOauthClientSecret.value : baseOauth.discord.clientSecret,
              redirectUri: redirectTouched ? teamDiscordOauthRedirectUri == null ? void 0 : teamDiscordOauthRedirectUri.value : baseOauth.discord.redirectUri
            },
            steam: {
              apiKey: clearSecrets ? null : steamKeyTouched ? teamSteamApiKeyInput == null ? void 0 : teamSteamApiKeyInput.value : baseOauth.steam.apiKey,
              realm: baseOauth.steam.realm,
              returnUrl: baseOauth.steam.returnUrl
            }
          });
          const updated = normalizeTeamDiscordConfig(__spreadProps(__spreadValues({}, current), { oauth }));
          state.teamDiscord.config = updated;
          hideNotice(teamOAuthStatus);
          updateTeamDiscordConfigUi2(updated);
        }
        function updateTeamDiscordUi2() {
          if (!teamDiscordSection) return;
          const canManage = canManageTeamDiscord();
          const stateObj = state.teamDiscord || {};
          ...
          const tokenPreview = typeof stateObj.tokenPreview === "string" && stateObj.tokenPreview.length ? stateObj.tokenPreview : null;
        ...
        async function loadTeamAuthSettings2({ force = false } = {}) {
          var _a2, _b2, _c;
          if (!teamAuthSection) return;
          if (!state.TOKEN) return;
          if (!canManageTeamDiscord()) {
            ...
            state.teamAuth.logChannelId = null;
            state.teamAuth.loaded = false;
            state.teamAuth.loadedTeamId = (_a2 = state.activeTeamId) != null ? _a2 : null;
            hideNotice(teamAuthStatus);
            updateTeamAuthUi();
            return;
          }
          ...
          try {
            ...
            state.teamAuth.enabled = Boolean(data == null ? void 0 : data.enabled);
            state.teamAuth.roleId = (data == null ? void 0 : data.roleId) != null && data.roleId !== "" ? String(data.roleId) : null;
            state.teamAuth.logChannelId = (data == null ? void 0 : data.logChannelId) != null && data.logChannelId !== "" ? String(data.logChannelId) : null;
            state.teamAuth.loaded = true;
            state.teamAuth.loadedTeamId = (_b2 = state.activeTeamId) != null ? _b2 : null;
          } catch (err) {
            if (errorCode(err) === "unauthorized") {
        ...
        async function loadTeamDiscord2({ force = false, refreshLists = false } = {}) {
          var _a2, _b2, _c, _d;
          if (!teamDiscordSection) return;
          if (!state.TOKEN) return;
          if (!canManageTeamDiscord()) {
          ...
          try {
            ...
            state.teamDiscord.hasToken = Boolean(data == null ? void 0 : data.hasToken);
            state.teamDiscord.guildId = (data == null ? void 0 : data.guildId) ? String(data.guildId) : null;
            state.teamDiscord.tokenPreview = (data == null ? void 0 : data.tokenPreview) ? String(data.tokenPreview) : null;
            state.teamDiscord.loadedTeamId = (_c = state.activeTeamId) != null ? _c : null;
            setTeamDiscordConfig((data == null ? void 0 : data.config) || defaultTeamDiscordConfig());
            state.teamDiscord.configLoaded = true;
            ...
            await loadTeamDiscordRoles2({ force: true, showStatus: refreshLists });
            ...
            if (errorCode(err) === "unauthorized") {
              ...
              state.teamDiscord.loadedTeamId = (_d = state.activeTeamId) != null ? _d : null;
              state.teamDiscordRoles = defaultTeamDiscordRolesState();
              state.teamDiscordChannels = defaultTeamDiscordChannelsState();
            ...
            updateTeamDiscordUi2();
            if (canManageTeamDiscord()) {
              loadTeamAuthSettings2({ force: true }).catch(() => {
              });
            }
          }
        ...
        async function handleTeamTicketingSubmit(ev) {
          ...
          ev == null ? void 0 : ev.preventDefault();
          if (!canManageTeamDiscord()) return;
          const hasSettings = Boolean(((_a2 = state.teamDiscord) == null ? void 0 : _a2.hasToken) || ((_b2 = state.teamDiscord) == null ? void 0 : _b2.guildId));
          if (!hasSettings) {
          ...
          updateTeamDiscordUi2();
          hideNotice(teamTicketingStatus);
          const payload = { config: normalizeTeamDiscordConfig(((_c = state.teamDiscord) == null ? void 0 : _c.config) || {}) };
          let unauthorized = false;
          try {
            const data = await api("/team/discord", payload, "POST");
            setTeamDiscordConfig((data == null ? void 0 : data.config) || payload.config);
            state.teamDiscord.hasToken = Boolean((_d = data == null ? void 0 : data.hasToken) != null ? _d : state.teamDiscord.hasToken);
            state.teamDiscord.guildId = (data == null ? void 0 : data.guildId) ? String(data.guildId) : state.teamDiscord.guildId;
            state.teamDiscord.tokenPreview = (data == null ? void 0 : data.tokenPreview) ? String(data.tokenPreview) : state.teamDiscord.tokenPreview;
            state.teamDiscord.loadedTeamId = (_e = state.activeTeamId) != null ? _e : null;
        ...
        async function handleTeamOAuthSubmit(ev) {
          ...
          updateTeamDiscordUi2();
          hideNotice(teamOAuthStatus);
          const payload = { config: normalizeTeamDiscordConfig(((_a2 = state.teamDiscord) == null ? void 0 : _a2.config) || {}) };
          let unauthorized = false;
          try {
            const data = await api("/team/discord", payload, "POST");
            setTeamDiscordConfig((data == null ? void 0 : data.config) || payload.config);
            state.teamDiscord.hasToken = Boolean((_b2 = data == null ? void 0 : data.hasToken) != null ? _b2 : state.teamDiscord.hasToken);
            state.teamDiscord.guildId = (data == null ? void 0 : data.guildId) ? String(data.guildId) : state.teamDiscord.guildId;
            state.teamDiscord.tokenPreview = (data == null ? void 0 : data.tokenPreview) ? String(data.tokenPreview) : state.teamDiscord.tokenPreview;
            state.teamDiscord.loadedTeamId = (_c = state.activeTeamId) != null ? _c : null;
        ...
        async function handleTeamDiscordSubmit(ev) {
          ...
          try {
            const data = await api(
              "/team/discord",
              { token: value, guildId: cleanedGuildId, config: ((_a2 = state.teamDiscord) == null ? void 0 : _a2.config) || {} },
              "POST"
            );
            state.teamDiscord.hasToken = Boolean(data == null ? void 0 : data.hasToken);
            state.teamDiscord.guildId = (data == null ? void 0 : data.guildId) ? String(data.guildId) : cleanedGuildId;
            state.teamDiscord.tokenPreview = (data == null ? void 0 : data.tokenPreview) ? String(data.tokenPreview) : null;
            state.teamDiscord.loadedTeamId = (_b2 = state.activeTeamId) != null ? _b2 : null;
            if (data == null ? void 0 : data.config) {
              setTeamDiscordConfig(data.config);
            }
            await loadTeamDiscordRoles2({ force: true });
        ...
        async function handleTeamDiscordRemove(ev) {
          ...
          ev == null ? void 0 : ev.preventDefault();
          if (!canManageTeamDiscord()) return;
          const guildIdStored = typeof state.teamDiscord.guildId === "string" ? state.teamDiscord.guildId : state.teamDiscord.guildId != null ? String(state.teamDiscord.guildId) : "";
        ...
        function updateTeamAccessView2({ refreshUsers = false, refreshAdmin = false } = {}) {
          const adminOnlyMode = false;
          const superuser = isSuperuser();
          const canUsers = adminOnlyMode ? false : hasGlobalPermission("manageUsers");
          const canRoles = adminOnlyMode ? false : hasGlobalPermission("manageRoles");
        ...
        async function loadSettings() {
          ...
          try {
            ...
            moduleBus.emit("settings:updated", { settings: __spreadValues({}, state.settings) });
          } catch (err) {
            if (errorCode(err) === "unauthorized") handleUnauthorized();
        ...
        async function saveSettings() {
          ...
          hideNotice(settingsStatus);
          const payload = { rustmaps_api_key: ((_a2 = rustMapsKeyInput == null ? void 0 : rustMapsKeyInput.value) == null ? void 0 : _a2.trim()) || "" };
          try {
        ...
        function renderPasskeys() {
          ...
          for (const passkey of list) {
            ...
            const lastUsed = passkey.last_used_at ? new Date(passkey.last_used_at).toLocaleString() : "Never used";
            meta.textContent = `Last used: ${lastUsed}`;
            const transports = Array.isArray(passkey.transports) && passkey.transports.length ? ` \xB7 ${passkey.transports.join(", ")}` : "";
        ...
        function renderBackupCodes() {
          ...
          if (codes.length) {
            ...
            li.textContent = remaining > 0 ? `${remaining} unused backup ${remaining === 1 ? "code" : "codes"} available. Generate new codes to view them.` : "Generate backup codes after enabling 2FA to keep an emergency login option.";
            backupCodesList.appendChild(li);
        ...
        function renderSecuritySettings() {
          ...
          btnEnableTotp == null ? void 0 : btnEnableTotp.classList.toggle("hidden", enabled);
          btnDisableTotp == null ? void 0 : btnDisableTotp.classList.toggle("hidden", !enabled);
          btnStartTotp == null ? void 0 : btnStartTotp.classList.toggle("hidden", enabled);
          if (totpSetupFields) {
            ...
            btnCopyTotpSecret == null ? void 0 : btnCopyTotpSecret.classList.toggle("hidden", !hasPending || !((_a2 = state.security.pendingSecret) == null ? void 0 : _a2.secret));
          }
          if (totpCodeInput) {
            totpCodeInput.value = "";
        ...
        async function loadSecuritySettings2() {
          var _a2;
          if (!state.TOKEN) {
          ...
          try {
            ...
            state.security = __spreadProps(__spreadValues({}, state.security), {
              totpEnabled: Boolean(data == null ? void 0 : data.totpEnabled),
              passkeys: Array.isArray(data == null ? void 0 : data.passkeys) ? data.passkeys : [],
              pendingSecret: null,
              backupCodes: [],
              backupCodesRemaining: Number(data == null ? void 0 : data.backupCodesRemaining) || 0,
              loaded: true,
            ...
            if (errorCode(err) === "unauthorized") handleUnauthorized();
              ...
              logMfa("failed to load security settings", {
                ...
                endpoint,
                error: detail,
                status: (err == null ? void 0 : err.status) || null,
                code: errorCode(err)
              });
        ...
        async function startTotpSetup() {
          ...
          try {
            ...
            logMfa("totp setup secret received", { api: state.API || "(unset)", qr: Boolean(data == null ? void 0 : data.qr) });
            renderSecuritySettings();
          } catch (err) {
            if (errorCode(err) === "unauthorized") handleUnauthorized();
            else {
        ...
        async function enableTotp() {
          ...
          const code = totpCodeInput == null ? void 0 : totpCodeInput.value.trim();
          if (!code) {
            showNotice(mfaStatusMessage, describeError("missing_fields"), "error");
            return;
          }
          if (!((_a2 = state.security.pendingSecret) == null ? void 0 : _a2.secret)) {
            await startTotpSetup();
            if (!((_b2 = state.security.pendingSecret) == null ? void 0 : _b2.secret)) return;
          }
          try {
            ...
            state.security.backupCodes = Array.isArray(result == null ? void 0 : result.backupCodes) ? result.backupCodes : [];
        ...
        async function generateBackupCodes() {
          ...
          try {
            ...
            state.security.backupCodes = Array.isArray(data == null ? void 0 : data.codes) ? data.codes : [];
            state.security.backupCodesRemaining = state.security.backupCodes.length || 0;
            renderSecuritySettings();
        ...
        async function copyTotpSecret() {
          var _a2, _b2;
          if (!((_a2 = state.security.pendingSecret) == null ? void 0 : _a2.secret)) return;
          try {
            if ((_b2 = navigator == null ? void 0 : navigator.clipboard) == null ? void 0 : _b2.writeText) {
            ...
            ui.log("Clipboard copy failed: " + ((err == null ? void 0 : err.message) || err));
          }
        ...
        async function registerPasskey() {
          ...
          try {
            ...
            const publicKey = preparePublicKeyOptions(data == null ? void 0 : data.options);
            ...
            state.security.passkeys = Array.isArray(result == null ? void 0 : result.passkeys) ? result.passkeys : [];
        ...
        async function completeLoginSession(payload, { resume = false } = {}) {
          if (payload == null ? void 0 : payload.token) {
          ...
          updateTeamAccessView2({ refreshUsers: true });
          startStatusPolling();
        }
        async function attemptSessionResume() {
          ...
          try {
            const me = await api("/me");
            await completeLoginSession(__spreadProps(__spreadValues({}, me), { token: state.TOKEN }), { resume: true });
          } catch (err) {
            if (errorCode(err) === "unauthorized") {
              logout();
            } else {
        ...
        function resetLoginMfa2() {
          state.pendingMfa = null;
          loginMfaStep == null ? void 0 : loginMfaStep.classList.add("hidden");
          if (loginMfaCode) loginMfaCode.value = "";
          hideNotice(loginMfaStatus);
        }
        function showMfaPrompt() {
          var _a2, _b2;
          if (!((_a2 = state.pendingMfa) == null ? void 0 : _a2.ticket)) return;
          hideNotice(loginError);
          hideNotice(loginMfaStatus);
          loginMfaStep == null ? void 0 : loginMfaStep.classList.remove("hidden");
          loginMfaCode == null ? void 0 : loginMfaCode.focus();
          if (((_b2 = state.pendingMfa.methods) == null ? void 0 : _b2.passkey) && state.pendingMfa.passkeyOptions) {
        ...
        async function submitMfaCode() {
          var _a2;
          hideNotice(loginMfaStatus);
          if (!((_a2 = state.pendingMfa) == null ? void 0 : _a2.ticket)) {
            showNotice(loginError, describeError("mfa_expired"), "error");
            return;
          }
          const code = loginMfaCode == null ? void 0 : loginMfaCode.value.trim();
          if (!code) {
        ...
        async function startPasskeyMfa(options = null) {
          ...
          try {
            const optPayload = options || ((_b2 = await publicJson("/login/mfa/passkey/options", {
              method: "POST",
              body: { ticket: state.pendingMfa.ticket }
            })) == null ? void 0 : _b2.options);
        ...
        async function handleLogin() {
          ...
          hideNotice(loginError);
          hideNotice(loginMfaStatus);
          const username = loginUsername == null ? void 0 : loginUsername.value.trim();
          const password = (loginPassword == null ? void 0 : loginPassword.value) || "";
          if (!username || !password) {
          ...
          try {
            ...
            if (errorCode(err) === "mfa_required") {
              state.pendingMfa = {
                ticket: ((_a2 = err.body) == null ? void 0 : _a2.ticket) || null,
                methods: ((_b2 = err.body) == null ? void 0 : _b2.methods) || {},
                passkeyOptions: ((_c = err.body) == null ? void 0 : _c.passkeyOptions) || null
              };
              ...
              loginPassword == null ? void 0 : loginPassword.focus();
            }
          } finally {
            if (btnLogin && restore) {
        ...
        async function handleRegister() {
          ...
          const username = regUsername == null ? void 0 : regUsername.value.trim();
          const password = (regPassword == null ? void 0 : regPassword.value) || "";
          const confirm = (regConfirm == null ? void 0 : regConfirm.value) || "";
        ...
        async function addServer() {
          ...
          const name = svName == null ? void 0 : svName.value.trim();
          const host = svHost == null ? void 0 : svHost.value.trim();
          const port = parseInt((svPort == null ? void 0 : svPort.value) || "0", 10);
          const password = svPass == null ? void 0 : svPass.value.trim();
          const useTls = !!(svTLS == null ? void 0 : svTLS.checked);
        ...
        async function runRconCommand2(command) {
        ...
        async function sendCommand() {
          const cmd = cmdInput == null ? void 0 : cmdInput.value.trim();
          if (!cmd) return;
          ...
          try {
            const reply = await runRconCommand2(cmd);
            ui.log("> " + cmd);
            const shouldEchoReply = !(socket == null ? void 0 : socket.connected) || !hasServerCapability("console") || !canAccessServerId(state.currentServerId);
            if ((reply == null ? void 0 : reply.Message) && shouldEchoReply) {
        ...
        function bindEvents() {
          navDashboard == null ? void 0 : navDashboard.addEventListener("click", () => {
            hideWorkspace("nav");
            switchPanel("dashboard");
            closeProfileMenu();
          });
          navTeam == null ? void 0 : navTeam.addEventListener("click", () => {
            if (navTeam.disabled) return;
            hideWorkspace("nav");
            switchPanel("team");
            closeProfileMenu();
          });
          navAdmin == null ? void 0 : navAdmin.addEventListener("click", () => {
            if (navAdmin.disabled) return;
            hideWorkspace("nav");
            switchPanel("admin");
            closeProfileMenu();
          });
          navLinked == null ? void 0 : navLinked.addEventListener("click", () => {
            if (navLinked.disabled) return;
            hideWorkspace("nav");
            switchPanel("linked");
            closeProfileMenu();
          });
          navDiscord == null ? void 0 : navDiscord.addEventListener("click", () => {
            if (navDiscord.disabled) return;
            hideWorkspace("nav");
            switchPanel("discord");
            closeProfileMenu();
          });
          navSettings == null ? void 0 : navSettings.addEventListener("click", () => {
          ...
          profileMenuTrigger == null ? void 0 : profileMenuTrigger.addEventListener("click", (ev) => {
            ev.preventDefault();
            if (!state.currentUser) return;
            toggleProfileMenu();
          });
          btnSaveSettings == null ? void 0 : btnSaveSettings.addEventListener("click", (e) => {
            e.preventDefault();
            saveSettings();
          });
          rustMapsKeyInput == null ? void 0 : rustMapsKeyInput.addEventListener("input", () => hideNotice(settingsStatus));
          btnChangePassword == null ? void 0 : btnChangePassword.addEventListener("click", (e) => {
            e.preventDefault();
            changePassword();
          });
          currentPasswordInput == null ? void 0 : currentPasswordInput.addEventListener("input", () => hideNotice(passwordStatus));
          newPasswordInput == null ? void 0 : newPasswordInput.addEventListener("input", () => hideNotice(passwordStatus));
          confirmPasswordInput == null ? void 0 : confirmPasswordInput.addEventListener("input", () => hideNotice(passwordStatus));
          confirmPasswordInput == null ? void 0 : confirmPasswordInput.addEventListener("keydown", (ev) => {
            if (ev.key === "Enter") {
              ev.preventDefault();
              changePassword();
            }
          });
          btnStartTotp == null ? void 0 : btnStartTotp.addEventListener("click", (e) => {
            e.preventDefault();
            startTotpSetup();
          });
          btnEnableTotp == null ? void 0 : btnEnableTotp.addEventListener("click", (e) => {
            e.preventDefault();
            enableTotp();
          });
          btnDisableTotp == null ? void 0 : btnDisableTotp.addEventListener("click", (e) => {
            e.preventDefault();
            disableTotp();
          });
          btnGenerateBackupCodes == null ? void 0 : btnGenerateBackupCodes.addEventListener("click", (e) => {
            e.preventDefault();
            generateBackupCodes();
          });
          btnCopyTotpSecret == null ? void 0 : btnCopyTotpSecret.addEventListener("click", (e) => {
            e.preventDefault();
            copyTotpSecret();
          });
          btnRegisterPasskey == null ? void 0 : btnRegisterPasskey.addEventListener("click", (e) => {
            e.preventDefault();
            registerPasskey();
          });
          btnSubmitMfa == null ? void 0 : btnSubmitMfa.addEventListener("click", (e) => {
            e.preventDefault();
            submitMfaCode();
          });
          btnMfaUsePasskey == null ? void 0 : btnMfaUsePasskey.addEventListener("click", (e) => {
            e.preventDefault();
            startPasskeyMfa();
          });
          loginMfaCode == null ? void 0 : loginMfaCode.addEventListener("keydown", (ev) => {
            if (ev.key === "Enter") {
              ev.preventDefault();
              submitMfaCode();
            }
          ...
          btnLogin == null ? void 0 : btnLogin.addEventListener("click", triggerLogin);
          loginUsername == null ? void 0 : loginUsername.addEventListener("keydown", (ev) => {
            if (ev.key === "Enter") triggerLogin(ev);
          });
          loginPassword == null ? void 0 : loginPassword.addEventListener("keydown", (ev) => {
            if (ev.key === "Enter") triggerLogin(ev);
          });
          loginUsername == null ? void 0 : loginUsername.addEventListener("input", () => hideNotice(loginError));
          loginPassword == null ? void 0 : loginPassword.addEventListener("input", () => hideNotice(loginError));
          btnRegister == null ? void 0 : btnRegister.addEventListener("click", handleRegister);
          btnAddServer == null ? void 0 : btnAddServer.addEventListener("click", addServer);
          btnSend == null ? void 0 : btnSend.addEventListener("click", sendCommand);
          cmdInput == null ? void 0 : cmdInput.addEventListener("keydown", (e) => {
            if (e.key === "Enter") {
              e.preventDefault();
              sendCommand();
            }
          });
          btnRefreshServers == null ? void 0 : btnRefreshServers.addEventListener("click", () => refreshServers());
          btnClearConsole == null ? void 0 : btnClearConsole.addEventListener("click", () => ui.clearConsole());
          addServerPrompt == null ? void 0 : addServerPrompt.addEventListener("click", () => toggleAddServerCardVisibility());
          btnBackToDashboard == null ? void 0 : btnBackToDashboard.addEventListener("click", () => hideWorkspace("back"));
          teamSelect == null ? void 0 : teamSelect.addEventListener("change", onTeamSelectionChange);
          teamDiscordForm == null ? void 0 : teamDiscordForm.addEventListener("submit", handleTeamDiscordSubmit);
          teamOAuthForm == null ? void 0 : teamOAuthForm.addEventListener("submit", handleTeamOAuthSubmit);
          btnSaveTeamOAuth == null ? void 0 : btnSaveTeamOAuth.addEventListener("click", handleTeamOAuthSubmit);
          btnClearTeamOAuth == null ? void 0 : btnClearTeamOAuth.addEventListener("click", handleClearTeamOAuth);
          teamTicketingForm == null ? void 0 : teamTicketingForm.addEventListener("submit", handleTeamTicketingSubmit);
          btnRemoveTeamDiscord == null ? void 0 : btnRemoveTeamDiscord.addEventListener("click", handleTeamDiscordRemove);
          teamDiscordToken == null ? void 0 : teamDiscordToken.addEventListener("input", () => hideNotice(teamDiscordStatus));
          teamDiscordGuildId == null ? void 0 : teamDiscordGuildId.addEventListener("input", () => hideNotice(teamDiscordStatus));
          [
          ...
          btnRefreshTeamDiscordChannels == null ? void 0 : btnRefreshTeamDiscordChannels.addEventListener("click", () => {
            loadTeamDiscordChannels({ force: true, showStatus: true }).catch(() => {
            });
          });
          teamAuthForm == null ? void 0 : teamAuthForm.addEventListener("submit", handleTeamAuthSubmit);
          teamAuthEnabledInput == null ? void 0 : teamAuthEnabledInput.addEventListener("change", () => {
            state.teamAuth.enabled = !!teamAuthEnabledInput.checked;
            hideNotice(teamAuthStatus);
            updateTeamAuthUi();
          });
          teamAuthRoleInput == null ? void 0 : teamAuthRoleInput.addEventListener("input", () => {
            const value = normalizeTeamAuthRoleId(teamAuthRoleInput.value);
            state.teamAuth.roleId = value ? value : null;
            hideNotice(teamAuthStatus);
          });
          teamAuthRoleSelect == null ? void 0 : teamAuthRoleSelect.addEventListener("change", () => {
          ...
          teamAuthLogChannelInput == null ? void 0 : teamAuthLogChannelInput.addEventListener("input", () => {
            const value = normalizeTeamAuthLogChannelId(teamAuthLogChannelInput.value);
            state.teamAuth.logChannelId = value ? value : null;
            hideNotice(teamAuthStatus);
          });
          teamAuthLogChannelSelect == null ? void 0 : teamAuthLogChannelSelect.addEventListener("change", () => {
          ...
          btnAdminCreateUser == null ? void 0 : btnAdminCreateUser.addEventListener("click", (event) => {
            event.preventDefault();
            handleAdminCreateUser();
          });
          adminUserSaveRole == null ? void 0 : adminUserSaveRole.addEventListener("click", handleAdminRoleSave);
          adminUserResetPassword == null ? void 0 : adminUserResetPassword.addEventListener("click", handleAdminPasswordReset);
          adminUserDelete == null ? void 0 : adminUserDelete.addEventListener("click", handleAdminDeleteUser);
          btnAdminAssignTeam == null ? void 0 : btnAdminAssignTeam.addEventListener("click", (event) => {
            event.preventDefault();
            handleAdminAssignTeam();
          });
          adminAssignTeam == null ? void 0 : adminAssignTeam.addEventListener("change", () => hideNotice(adminAssignStatus));
          adminAssignRole == null ? void 0 : adminAssignRole.addEventListener("change", () => hideNotice(adminAssignStatus));
          adminUserSuperuser == null ? void 0 : adminUserSuperuser.addEventListener("change", () => hideNotice(adminUserRoleStatus));
          adminUserSearch == null ? void 0 : adminUserSearch.addEventListener("input", () => {
            adminUserFilter = adminUserSearch.value || "";
            renderAdminUsers();
          });
          adminNewUserName == null ? void 0 : adminNewUserName.addEventListener("input", () => hideNotice(adminUserFeedback));
          adminNewUserPassword == null ? void 0 : adminNewUserPassword.addEventListener("input", () => hideNotice(adminUserFeedback));
          adminNewUserRole == null ? void 0 : adminNewUserRole.addEventListener("change", () => hideNotice(adminUserFeedback));
          adminNewUserSuperuser == null ? void 0 : adminNewUserSuperuser.addEventListener("change", () => hideNotice(adminUserFeedback));
          btnCreateUser == null ? void 0 : btnCreateUser.addEventListener("click", async () => {
            if (!hasGlobalPermission("manageUsers")) return;
            hideNotice(userFeedback);
            hideNotice(existingUserFeedback);
            const username = newUserName == null ? void 0 : newUserName.value.trim();
            const password = (newUserPassword == null ? void 0 : newUserPassword.value) || "";
            const role = (newUserRole == null ? void 0 : newUserRole.value) || "user";
            if (!username || !password) {
          ...
          btnAddExistingUser == null ? void 0 : btnAddExistingUser.addEventListener("click", async () => {
            if (!hasGlobalPermission("manageUsers")) return;
            hideNotice(existingUserFeedback);
            const username = existingUserName == null ? void 0 : existingUserName.value.trim();
            const role = (existingUserRole == null ? void 0 : existingUserRole.value) || "user";
            if (!username) {
          ...
          existingUserName == null ? void 0 : existingUserName.addEventListener("input", () => hideNotice(existingUserFeedback));
          existingUserRole == null ? void 0 : existingUserRole.addEventListener("change", () => hideNotice(existingUserFeedback));
          userDetailsRoleSelect == null ? void 0 : userDetailsRoleSelect.addEventListener("change", () => hideNotice(userDetailsRoleStatus));
          roleSelect == null ? void 0 : roleSelect.addEventListener("change", () => {
            if (!hasGlobalPermission("manageRoles")) return;
            hideNotice(roleFeedback);
            openRoleEditor(roleSelect.value);
          });
          btnCreateRole == null ? void 0 : btnCreateRole.addEventListener("click", (ev) => {
            ev.preventDefault();
            handleRoleCreate();
          });
          btnSaveRole == null ? void 0 : btnSaveRole.addEventListener("click", (ev) => {
            ev.preventDefault();
            handleRoleSave();
          });
          btnDeleteRole == null ? void 0 : btnDeleteRole.addEventListener("click", (ev) => {
            ev.preventDefault();
            handleRoleDelete();
          });
          newRoleKey == null ? void 0 : newRoleKey.addEventListener("input", () => hideNotice(roleFeedback));
          newRoleName == null ? void 0 : newRoleName.addEventListener("input", () => hideNotice(roleFeedback));
          roleNameInput == null ? void 0 : roleNameInput.addEventListener("input", () => hideNotice(roleFeedback));
          roleDescriptionInput == null ? void 0 : roleDescriptionInput.addEventListener("input", () => hideNotice(roleFeedback));
          roleServersList == null ? void 0 : roleServersList.addEventListener("change", handleRoleServersChange);
          renderRoleServersOptions();
          setAddServerPromptState(addServerCard && !addServerCard.classList.contains("hidden"));
          document.addEventListener("click", (ev) => {
            const target = ev.target instanceof Node ? ev.target : null;
            if (!target) return;
            if ((profileMenuTrigger == null ? void 0 : profileMenuTrigger.contains(target)) || (userBox == null ? void 0 : userBox.contains(target))) return;
            closeProfileMenu();
          });
