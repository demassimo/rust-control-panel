...
- `assets/js/panel-shell.js` – Shell utilities shared across modules (panel toggles, layout helpers, shared event bus).
...
- `assets/modules/live-console.js` – Renders live RCON console output with severity highlighting and auto-scrolling behaviour.【F:frontend/assets/modules/live-console.js†L1-L80】
